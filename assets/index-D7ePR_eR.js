...
Good luck for the auction!`,u=s?`https://wa.me/91${s}?text=${encodeURIComponent(c)}`:`https://api.whatsapp.com/send?text=${encodeURIComponent(c)}`;window.open(u,"_blank")}function Sr(e,t,a="Cricket Tournament"){if(!e)return;const n=(t||[]).filter(p=>p.sold_team_id===e.id).sort((p,f)=>{const b=p.is_captain||p.status==="captain"||e.captain_player_id&&p.id===e.captain_player_id?1:0;return(f.is_captain||f.status==="captain"||e.captain_player_id&&f.id===e.captain_player_id?1:0)-b});if(n.length===0){alert(`No players found in ${e.name}'s squad yet. Players will appear here once acquired in the auction.`);return}const r=p=>String(p??"").replace(/[&<>"']/g,f=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[f]),s=n.map((p,f)=>{const b=p.is_captain||p.status==="captain"||e.captain_player_id&&p.id===e.captain_player_id,y=b?'<span class="captain-badge">👑 CAPTAIN</span>':'<span class="player-badge">PLAYER</span>',m=b?"🪙 0 (Captain)":`🪙 ${Number(p.sold_price||0).toLocaleString("en-IN")}`,h=p.birth_date?p.birth_date:"—";return`
      <tr>
...
</html>`,y=window.open("","_blank");if(!y){alert("Please allow pop-ups to open the PDF export.");return}y.document.write(b),y.document.close(),y.onload=()=>{setTimeout(()=>{try{y.print()}catch{}},350)}}function zr(e,t=1e3){const a=Number(e)||0;return a<t?t:a<2e4?Math.floor(a/1e3)*1e3+1e3:Math.floor(a/2e3)*2e3+2e3}function Er(e,t=1e3){const a=Number(e)||0;let n;return a>2e4?(n=Math.ceil(a/2e3)*2e3-2e3,n<2e4&&(n=2e4)):n=Math.ceil(a/1e3)*1e3-1e3,Math.max(t,n)}function Hn({size:e=36}){return o.jsx("img",{src:"/logo-icon-v4.png",alt:"Selected Sports",style:{height:e,width:"auto",display:"block"}})}function Rr({size:e=40}){return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10},children:[o.jsx(Hn,{size:e}),o.jsxs("div",{children:[o.jsx("div",{style:{color:"#0F172A",fontFamily:"var(--font-head)",fontWeight:700,fontSize:e*.44,letterSpacing:"-0.5px",lineHeight:1.1},children:"Selected"}),o.jsx("div",{style:{color:"#B8860B",fontFamily:"var(--font-head)",fontWeight:600,fontSize:e*.27,letterSpacing:"2.5px",textTransform:"uppercase",lineHeight:1.1},children:"Sports"})]})]})}function U({name:e,id:t,sz:a=34}){return o.jsx("div",{style:{width:a,height:a,borderRadius:"50%",background:Ln(t),display:"flex",alignItems:"center",justifyContent:"center",fontSize:a*.3,fontWeight:700,color:"#0F172A",flexShrink:0,letterSpacing:"-0.5px",fontFamily:"var(--font-head)"},children:Nn(e)})}const we={green:{bg:"rgba(25,182,106,0.12)",tx:"rgba(34,197,94,0.15)"},lime:{bg:"rgba(132,204,22,0.12)",tx:"#4D7C0F"},yellow:{bg:"rgba(244,180,0,0.12)",tx:"rgba(246,196,83,0.15)"},red:{bg:"rgba(229,57,53,0.1)",tx:"rgba(231,76,60,0.15)"},blue:{bg:"rgba(37,95,184,0.1)",tx:"#FFFFFF"},teal:{bg:"rgba(20,184,166,0.12)",tx:"#0F766E"},orange:{bg:"rgba(251,146,60,0.12)",tx:"rgba(251,146,60,0.15)"},purple:{bg:"rgba(167,139,250,0.12)",tx:"rgba(91,33,182,0.12)"},gray:{bg:"#F8FAF8",tx:"#F8FAF8"}},_e={founder:{label:"Founder",icon:ke,bg:"linear-gradient(135deg,#FBBF24,#D4A017)",color:"#FFFFFF"},organizer:{label:"Organizer",icon:ut,bg:"#166534",color:"#FFFFFF"},pro:{label:"PRO",icon:dt,bg:"#FFFFFF",color:"#2563EB",border:"1.5px solid #2563EB"},player:{label:"Player",icon:ve,bg:"#22C55E",color:"#FFFFFF"},guest:{label:"Guest",icon:ct,bg:"#FFFFFF",color:"#64748B",border:"1.5px solid #E2E8F0"}};function Fe({role:e="player",size:t="md"}){const[a,n]=_.useState(!1);_.useEffect(()=>{const l=setTimeout(()=>n(!0),10);return()=>clearTimeout(l)},[]);const r=_e[e]||_e.player,s=t==="sm";return o.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:s?4:6,padding:s?"3px 9px":"5px 13px",borderRadius:999,background:r.bg,color:r.color,border:r.border||"none",fontSize:s?10:12,fontWeight:700,fontFamily:"var(--font-body)",boxShadow:"0 2px 6px rgba(15,23,42,0.12)",whiteSpace:"nowrap",opacity:a?1:0,transform:a?"scale(1)":"scale(0.95)",transition:"opacity 250ms, transform 250ms"},children:[o.jsx(r.icon,{size:s?11:13}),r.label]})}function qr({children:e,col:t="gray"}){const a=we[t]||we.gray;return o.jsx("span",{style:{background:a.bg,color:a.tx,borderRadius:6,padding:"3px 9px",fontSize:11,fontWeight:700,whiteSpace:"nowrap",display:"inline-block",fontFamily:"var(--font-head)"},children:e})}function $r({children:e,onClick:t,variant:a="primary",size:n="md",disabled:r=!1,style:s={}}){const l={border:"none",borderRadius:10,cursor:r?"not-allowed":"pointer",fontWeight:600,fontFamily:"var(--font-body)",display:"inline-flex",alignItems:"center",justifyContent:"center",gap:6,opacity:r?.55:1},d={primary:{background:"linear-gradient(135deg,#166534,#FFFFFF)",color:"#0F172A"},green:{background:"#166534",color:"#0F172A"},danger:{background:"rgba(229,57,53,0.1)",color:"#DC2626",border:"1px solid rgba(229,57,53,0.3)"},ghost:{background:"#F8FAF8",color:"#0F172A"},wa:{background:"rgba(25,182,106,0.12)",color:"#166534",border:"1px solid rgba(25,182,106,0.3)"},outline:{background:"transparent",color:"#166534",border:"1.5px solid #166534"},dark:{background:"#FFFFFF",color:"#0F172A",border:"none"}},c={sm:{padding:"5px 12px",fontSize:12},md:{padding:"9px 18px",fontSize:13},lg:{padding:"12px 24px",fontSize:14}};return o.jsx("button",{onClick:r?void 0:t,style:{...l,...d[a],...c[n],...s},children:e})}function G(){return o.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",padding:48},children:[o.jsx("div",{style:{width:32,height:32,borderRadius:"50%",border:"3px solid #E2E8F0",borderTopColor:"#166534",animation:"spin 0.7s linear infinite"}}),o.jsx("style",{children:"@keyframes spin{to{transform:rotate(360deg)}}"})]})}function K({children:e,style:t={},onClick:a}){return o.jsx("div",{onClick:a,style:{background:"#FFFFFF",borderRadius:16,border:"1.5px solid #E2E8F0",boxShadow:"0 1px 4px rgba(37,95,184,0.06)",...t},children:e})}function Br({messages:e,onClose:t,player:a}){const[n,r]=_.useState(""),[s,l]=_.useState(!1),[d,c]=_.useState(!1),[u,p]=_.useState(null),[f,b]=_.useState([]),[y,m]=_.useState(!1),h=async()=>{if(!(!n.trim()||!a)){l(!0);try{const x=await De();x&&(await Te(a.id,x,n.trim()),c(!0),r(""))}catch(x){alert(x.message)}l(!1)}},w=x=>{const F=x.match(/\[\[match:([a-zA-Z0-9-]+)\]\]/);return{clean:x.replace(/\[\[match:[a-zA-Z0-9-]+\]\]/,"").trim(),matchId:F?F[1]:null}},C=async x=>{p(x),m(!0);try{b(await ze(x))}catch(F){alert(F.message)}m(!1)};if(u){const x=f.filter(S=>S.status==="confirmed"),F=f.filter(S=>S.status==="waitlist");return o.jsx("div",{onClick:t,style:{position:"fixed",inset:0,background:"rgba(15,23,42,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:500,padding:16},children:o.jsxs("div",{onClick:S=>S.stopPropagation(),style:{background:"#FFFFFF",border:"1.5px solid #E2E8F0",borderRadius:16,maxWidth:420,width:"100%",maxHeight:"80vh",overflowY:"auto",padding:20,boxShadow:"0 24px 60px rgba(15,23,42,0.35)"},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14},children:[o.jsxs("button",{onClick:()=>p(null),style:{background:"transparent",border:"none",fontSize:13,fontWeight:700,color:"#166534",cursor:"pointer",display:"flex",alignItems:"center",gap:4,padding:0},children:[o.jsx(pt,{size:15})," Back"]}),o.jsx("button",{onClick:t,style:{background:"transparent",border:"none",fontSize:20,cursor:"pointer",color:"#64748B"},children:"×"})]}),y?o.jsx(G,{}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{style:{fontWeight:700,fontSize:14,color:"#0F172A",marginBottom:10,fontFamily:"var(--font-head)"},children:["Confirmed (",x.length,")"]}),o.jsx("div",{style:{marginBottom:18},children:x.length===0?o.jsx("div",{style:{color:"#94A3B8",fontSize:12},children:"No one confirmed yet."}):x.map(S=>{var z,P;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"7px 0"},children:[o.jsx(U,{name:((z=S.players)==null?void 0:z.name)||"Player",id:S.player_id,sz:28}),o.jsx("span",{style:{fontSize:13,color:"#0F172A",fontWeight:600},children:((P=S.players)==null?void 0:P.name)||"Player"})]},S.id)})}),o.jsxs("div",{style:{fontWeight:700,fontSize:14,color:"#B8860B",marginBottom:10,fontFamily:"var(--font-head)"},children:["Waitlist (",F.length,")"]}),o.jsx("div",{children:F.length===0?o.jsx("div",{style:{color:"#94A3B8",fontSize:12},children:"No one on the waitlist."}):F.map(S=>{var z,P;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"7px 0"},children:[o.jsx(U,{name:((z=S.players)==null?void 0:z.name)||"Player",id:S.player_id,sz:28}),o.jsx("span",{style:{fontSize:13,color:"#0F172A",fontWeight:600},children:((P=S.players)==null?void 0:P.name)||"Player"})]},S.id)})})]})]})})}return o.jsx("div",{onClick:t,style:{position:"fixed",inset:0,background:"rgba(15,23,42,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:500,padding:16},children:o.jsxs("div",{onClick:x=>x.stopPropagation(),style:{background:"#FFFFFF",border:"1.5px solid #E2E8F0",borderRadius:16,maxWidth:420,width:"100%",maxHeight:"80vh",overflowY:"auto",padding:20,boxShadow:"0 24px 60px rgba(15,23,42,0.35)"},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14},children:[o.jsxs("div",{style:{fontWeight:700,fontSize:16,fontFamily:"var(--font-head)",color:"#0F172A",display:"flex",alignItems:"center",gap:8},children:[o.jsx(ft,{size:18})," Messages"]}),o.jsx("button",{onClick:t,style:{background:"transparent",border:"none",fontSize:20,cursor:"pointer",color:"#64748B"},children:"×"})]}),e.length===0&&o.jsx("div",{style:{color:"#64748B",fontSize:13,textAlign:"center",padding:"20px 0"},children:"No messages yet."}),e.map(x=>{const{clean:F,matchId:S}=w(x.message);return o.jsxs("div",{onClick:S?()=>C(S):void 0,style:{padding:"12px 0",borderBottom:"1px solid #E2E8F0",cursor:S?"pointer":"default"},children:[o.jsx("div",{style:{fontSize:13,color:"#0F172A",lineHeight:1.5},children:F}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:5,display:"flex",alignItems:"center",gap:6},children:["From ",x.sender," · ",x.created_at?new Date(x.created_at).toLocaleString():"",S&&o.jsxs("span",{style:{color:"#166534",fontWeight:700,display:"flex",alignItems:"center",gap:2},children:["· View squad ",o.jsx(Pe,{size:11})]})]})]},x.id)}),a&&o.jsxs("div",{style:{marginTop:14,paddingTop:14,borderTop:"1.5px solid #E2E8F0"},children:[o.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#0F172A",marginBottom:8},children:"Reply to Admin"}),d&&o.jsx("div",{style:{fontSize:12,color:"#166534",marginBottom:8},children:"✓ Sent! Full conversation is in Direct Messages."}),o.jsxs("div",{style:{display:"flex",gap:8},children:[o.jsx("input",{value:n,onChange:x=>r(x.target.value),onKeyDown:x=>x.key==="Enter"&&h(),placeholder:"Type a reply...",style:{flex:1,padding:"9px 12px",borderRadius:9,border:"1.5px solid #E2E8F0",background:"#F8FAF8",color:"#0F172A",fontSize:13,outline:"none",fontFamily:"var(--font-body)"}}),o.jsx("button",{onClick:h,disabled:s,style:{padding:"9px 14px",borderRadius:9,background:"#166534",border:"none",color:"#0F172A",fontSize:13,cursor:"pointer",fontWeight:600},children:s?"...":"Send"})]})]})]})})}function Tr({isMobile:e,myId:t}){var me;const[n,r]=_.useState([]),[s,l]=_.useState(!0),[d,c]=_.useState(null),[u,p]=_.useState(!1),[f,b]=_.useState(!1),[y,m]=_.useState("points"),[h,w]=_.useState("all"),[C,x]=_.useState(!1),[F,S]=_.useState("all"),[z,P]=_.useState(!1),[$,A]=_.useState(""),[k,B]=_.useState(null);if(_.useEffect(()=>{Re().then(g=>{r(g),setTimeout(()=>p(!0),50),g.length>0&&(b(!0),setTimeout(()=>b(!1),2200))}).catch(g=>c(g.message||String(g))).finally(()=>l(!1))},[]),s)return o.jsx(G,{});const W=Array.from(new Set(n.map(g=>{var v;return(((v=g.matches)==null?void 0:v.date)||"").slice(0,4)}).filter(Boolean))).sort().reverse(),N=n.filter(g=>{var v,R;return!(h!=="all"&&(((v=g.matches)==null?void 0:v.date)||"").slice(0,4)!==h||F!=="all"&&(((R=g.players)==null?void 0:R.role)||"player")!==F)}),j={};N.forEach(g=>{const v=g.players;v&&(j[v.id]||(j[v.id]={id:v.id,name:v.name,city:v.city,role:v.role,profile_image_url:v.profile_image_url,matchesPlayed:0,matches:[],earliestConfirmedAt:g.created_at}),j[v.id].matchesPlayed++,g.matches&&j[v.id].matches.push({...g.matches,confirmedAt:g.created_at}),g.created_at&&(!j[v.id].earliestConfirmedAt||g.created_at<j[v.id].earliestConfirmedAt)&&(j[v.id].earliestConfirmedAt=g.created_at))});const q=Object.values(j).map(g=>({...g,points:g.matchesPlayed*20})).sort((g,v)=>v.points!==g.points?v.points-g.points:g.earliestConfirmedAt?v.earliestConfirmedAt?new Date(g.earliestConfirmedAt)-new Date(v.earliestConfirmedAt):-1:1),T=$.trim().toLowerCase(),Ke=q.filter(g=>!T||g.name.toLowerCase().includes(T)||(g.city||"").toLowerCase().includes(T)),Y=q.slice(0,3),fe=T?Ke:q.slice(3),V=t?q.findIndex(g=>g.id===t):-1,Ze={1:{title:"👑 MVP · CHAMPION",border:"2px solid #F59E0B",bg:"linear-gradient(180deg, rgba(245,158,11,0.18) 0%, rgba(245,158,11,0.03) 100%)",badgeBg:"linear-gradient(135deg, #F59E0B, #D97706)",glow:"0 10px 28px rgba(245,158,11,0.28)",avatarBorder:"#F59E0B",avatarGlow:"0 0 20px rgba(245,158,11,0.4)"},2:{title:"🥈 2ND PLACE",border:"1.5px solid #CBD5E1",bg:"linear-gradient(180deg, rgba(241,245,249,0.9) 0%, rgba(255,255,255,0.8) 100%)",badgeBg:"linear-gradient(135deg, #94A3B8, #64748B)",glow:"0 8px 20px rgba(100,116,139,0.15)",avatarBorder:"#94A3B8",avatarGlow:"none"},3:{title:"🥉 3RD PLACE",border:"1.5px solid #FDE68A",bg:"linear-gradient(180deg, rgba(254,243,199,0.5) 0%, rgba(255,255,255,0.8) 100%)",badgeBg:"linear-gradient(135deg, #D97706, #B45309)",glow:"0 8px 20px rgba(180,83,9,0.15)",avatarBorder:"#D97706",avatarGlow:"none"}},te=({p:g,rank:v})=>{if(!g)return o.jsx("div",{style:{flex:1}});const R=Ze[v],E=v===1;return o.jsxs("div",{onClick:()=>B(g),style:{flex:1,display:"flex",flexDirection:"column",alignItems:"center",cursor:"pointer",opacity:u?1:0,transform:u?E?"translateY(-6px) scale(1.02)":"translateY(0) scale(1)":"translateY(24px) scale(0.95)",transition:`all 350ms cubic-bezier(0.16, 1, 0.3, 1) ${v===1?200:v===2?100:0}ms`,zIndex:E?3:2},children:[E&&o.jsxs("div",{style:{background:R.badgeBg,color:"#FFFFFF",fontSize:10,fontWeight:900,padding:"4px 12px",borderRadius:999,display:"inline-flex",alignItems:"center",gap:5,marginBottom:8,boxShadow:"0 4px 12px rgba(245,158,11,0.4)",letterSpacing:.5,fontFamily:"var(--font-head)"},children:[o.jsx(ke,{size:12,fill:"#FFFFFF"})," MVP · RANK 1"]}),o.jsxs("div",{style:{position:"relative",padding:E?e?"18px 10px 16px":"24px 16px 20px":e?"14px 8px 12px":"18px 12px 16px",borderRadius:20,background:R.bg,border:R.border,width:"100%",textAlign:"center",boxShadow:R.glow,boxSizing:"border-box"},children:[o.jsxs("div",{style:{position:"relative",display:"inline-block",marginBottom:10},children:[o.jsx("div",{style:{borderRadius:"50%",boxShadow:R.avatarGlow,padding:2,background:"#FFFFFF",border:`2px solid ${R.avatarBorder}`},children:g.profile_image_url?o.jsx("img",{src:g.profile_image_url,alt:g.name,style:{width:E?e?54:68:e?42:52,height:E?e?54:68:e?42:52,borderRadius:"50%",objectFit:"cover",display:"block"}}):o.jsx(U,{name:g.name,id:g.id,sz:E?e?54:68:e?42:52})}),o.jsx("div",{style:{position:"absolute",bottom:-4,right:-4,width:E?24:20,height:E?24:20,borderRadius:"50%",background:R.badgeBg,color:"#FFFFFF",fontSize:E?12:10,fontWeight:900,display:"flex",alignItems:"center",justifyContent:"center",border:"2px solid #FFFFFF",boxShadow:"0 2px 6px rgba(0,0,0,0.2)"},children:v})]}),o.jsx("div",{style:{fontWeight:800,fontSize:E?e?13:15:e?12:13,color:"#0F172A",fontFamily:"var(--font-head)",lineHeight:1.2,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:g.name}),o.jsxs("div",{style:{marginTop:4,display:"flex",justifyContent:"center",alignItems:"center",gap:4},children:[g.role&&g.role!=="player"?o.jsx(Fe,{role:g.role,size:"sm"}):o.jsx("span",{style:{fontSize:9.5,fontWeight:800,background:"rgba(22,101,52,0.1)",color:"#166534",padding:"1px 6px",borderRadius:4},children:"PLAYER"}),g.city&&!e&&o.jsxs("span",{style:{fontSize:10,color:"#94A3B8"},children:["· ",g.city]})]}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:4,fontWeight:600},children:[g.matchesPlayed," Matches"]}),o.jsxs("div",{style:{fontSize:E?e?18:22:e?15:18,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)",marginTop:4,display:"flex",alignItems:"center",justifyContent:"center",gap:3},children:[o.jsx("span",{children:g.points}),o.jsx("span",{style:{fontSize:10,fontWeight:800,color:"#94A3B8"},children:"PTS"})]})]})]})},Je=({i:g})=>{const v=["#F59E0B","#166534","#22C55E","#FBBF24","#3B82F6"],R=Math.random()*100,E=Math.random()*300,ne=1200+Math.random()*600,O=Math.random()*360,Qe=v[g%v.length];return o.jsx("div",{style:{position:"absolute",top:-10,left:R+"%",width:8,height:8,background:Qe,borderRadius:g%2===0?"50%":2,animation:`confettiFall ${ne}ms ease-in ${E}ms forwards`,transform:`rotate(${O}deg)`}})},ae=({label:g,desc:v})=>o.jsxs(K,{style:{padding:"44px 20px",textAlign:"center",borderRadius:16},children:[o.jsx("div",{style:{width:56,height:56,borderRadius:"50%",background:"#F8FAF8",border:"1.5px solid #E2E8F0",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 14px"},children:o.jsx(he,{size:26,color:"#94A3B8"})}),o.jsxs("div",{style:{fontWeight:900,fontSize:16,color:"#0F172A",marginBottom:6,fontFamily:"var(--font-head)"},children:[g," Leaderboard Coming Soon"]}),o.jsx("div",{style:{color:"#64748B",fontSize:13,maxWidth:360,margin:"0 auto",lineHeight:1.5},children:v||"Individual batting and bowling statistics will populate automatically once ball-by-ball live match scoring is active."})]});return o.jsxs("div",{style:{position:"relative"},children:[o.jsx("style",{children:`
        @keyframes confettiFall {
          0% { opacity: 1; transform: translateY(0) rotate(0deg); }
          100% { opacity: 0; transform: translateY(260px) rotate(320deg); }
        }
      `}),f&&o.jsx("div",{style:{position:"absolute",top:0,left:0,right:0,height:260,overflow:"hidden",pointerEvents:"none",zIndex:10},children:Array.from({length:36}).map((g,v)=>o.jsx(Je,{i:v},v))}),o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:e?"flex-start":"center",marginBottom:16,gap:12,flexDirection:e?"column":"row",flexWrap:"wrap"},children:[o.jsx("div",{children:o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[o.jsx("div",{style:{width:38,height:38,borderRadius:10,background:"linear-gradient(135deg, rgba(245,158,11,0.15), rgba(22,101,52,0.1))",border:"1px solid rgba(245,158,11,0.3)",display:"flex",alignItems:"center",justifyContent:"center"},children:o.jsx(Se,{size:20,color:"#D97706"})}),o.jsxs("div",{children:[o.jsx("h2",{style:{fontFamily:"var(--font-head)",color:"#0F172A",fontSize:e?19:22,margin:0,fontWeight:900,letterSpacing:"-0.4px"},children:"Player Leaderboard"}),o.jsx("div",{style:{fontSize:11.5,color:"#64748B",marginTop:2},children:"Official community rankings calculated from verified match appearances (20 PTS / Match)"})]})]})}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,width:e?"100%":"auto",flexWrap:"wrap"},children:[o.jsxs("div",{style:{position:"relative"},children:[o.jsxs("button",{type:"button",onClick:()=>{x(g=>!g),P(!1)},style:{padding:"8px 12px",borderRadius:10,border:"1.5px solid #E2E8F0",background:"#FFFFFF",color:"#0F172A",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6},children:[o.jsx(ot,{size:13,color:"#166534"}),o.jsx("span",{children:h==="all"?"All Seasons":`Season ${h}`}),o.jsx(ge,{size:13,color:"#94A3B8"})]}),C&&o.jsxs("div",{style:{position:"absolute",top:"100%",right:0,marginTop:4,background:"#FFFFFF",border:"1px solid #E2E8F0",borderRadius:10,boxShadow:"0 10px 30px rgba(15,23,42,0.15)",zIndex:30,minWidth:140,overflow:"hidden"},children:[o.jsx("button",{type:"button",onClick:()=>{w("all"),x(!1)},style:{width:"100%",padding:"10px 14px",border:"none",background:h==="all"?"rgba(34,197,94,0.08)":"none",textAlign:"left",fontSize:12.5,color:"#0F172A",cursor:"pointer",fontWeight:h==="all"?800:500},children:"All Seasons"}),W.map(g=>o.jsxs("button",{type:"button",onClick:()=>{w(g),x(!1)},style:{width:"100%",padding:"10px 14px",border:"none",background:h===g?"rgba(34,197,94,0.08)":"none",textAlign:"left",fontSize:12.5,color:"#0F172A",cursor:"pointer",fontWeight:h===g?800:500},children:["Season ",g]},g))]})]}),o.jsxs("div",{style:{position:"relative"},children:[o.jsxs("button",{type:"button",onClick:()=>{P(g=>!g),x(!1)},style:{padding:"8px 12px",borderRadius:10,border:"1.5px solid #E2E8F0",background:"#FFFFFF",color:"#0F172A",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6},children:[o.jsx("span",{children:F==="all"?"All Players":F==="pro"?"PRO Only":"Players Only"}),o.jsx(ge,{size:13,color:"#94A3B8"})]}),z&&o.jsx("div",{style:{position:"absolute",top:"100%",right:0,marginTop:4,background:"#FFFFFF",border:"1px solid #E2E8F0",borderRadius:10,boxShadow:"0 10px 30px rgba(15,23,42,0.15)",zIndex:30,minWidth:140,overflow:"hidden"},children:[["all","All Players"],["player","Players Only"],["pro","PRO Only"]].map(([g,v])=>o.jsx("button",{type:"button",onClick:()=>{S(g),P(!1)},style:{width:"100%",padding:"10px 14px",border:"none",background:F===g?"rgba(34,197,94,0.08)":"none",textAlign:"left",fontSize:12.5,color:"#0F172A",cursor:"pointer",fontWeight:F===g?800:500},children:v},g))})]})]})]}),o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:10,marginBottom:18,flexDirection:e?"column":"row"},children:[o.jsx("div",{style:{display:"flex",gap:8,overflowX:"auto",width:e?"100%":"auto",paddingBottom:2},children:[["points","Points Table",it],["runs","Most Runs",he],["wickets","Most Wickets",st],["sixes","Most 6s",je]].map(([g,v,R])=>o.jsxs("button",{type:"button",onClick:()=>m(g),style:{padding:"8px 14px",borderRadius:999,border:y===g?"none":"1.5px solid #E2E8F0",background:y===g?"#166534":"#FFFFFF",color:y===g?"#FFFFFF":"#64748B",fontSize:12,fontWeight:800,cursor:"pointer",display:"flex",alignItems:"center",gap:6,whiteSpace:"nowrap",flexShrink:0,boxShadow:y===g?"0 2px 8px rgba(22,101,52,0.25)":"none",transition:"all 150ms ease"},children:[o.jsx(R,{size:13}),o.jsx("span",{children:v})]},g))}),y==="points"&&o.jsxs("div",{style:{width:e?"100%":240,position:"relative"},children:[o.jsx(lt,{size:14,color:"#94A3B8",style:{position:"absolute",left:12,top:"50%",transform:"translateY(-50%)"}}),o.jsx("input",{type:"text",value:$,onChange:g=>A(g.target.value),placeholder:"Search ranked player...",style:{width:"100%",padding:"8px 12px 8px 32px",borderRadius:999,border:"1.5px solid #E2E8F0",fontSize:12,outline:"none",background:"#FFFFFF",boxSizing:"border-box",fontFamily:"var(--font-body)"}})]})]}),y==="runs"&&o.jsx(ae,{label:"Most Runs",desc:"Track top batsmen across tournaments once live match scoring is recorded."}),y==="wickets"&&o.jsx(ae,{label:"Most Wickets",desc:"Track top wicket-takers across matches once match scorecards are submitted."}),y==="sixes"&&o.jsx(ae,{label:"Most 6s",desc:"Track maximum sixes hit per season once live innings balls are captured."}),y==="points"&&(d?o.jsxs("div",{style:{color:"#EF4444",fontSize:13,textAlign:"center",padding:"30px 0",background:"rgba(239,68,68,0.06)",borderRadius:12,border:"1px solid rgba(239,68,68,0.25)"},children:["⚠️ Couldn't load the leaderboard: ",d]}):q.length===0?o.jsx(K,{style:{padding:"40px 20px",textAlign:"center",borderRadius:16},children:o.jsxs("div",{style:{fontSize:14,color:"#64748B"},children:["No completed matches recorded yet",h!=="all"?` for Season ${h}`:"","."]})}):o.jsxs(o.Fragment,{children:[!T&&Y.length>0&&o.jsxs("div",{style:{display:"flex",alignItems:"stretch",gap:e?8:14,marginBottom:22,padding:"0 2px"},children:[o.jsx(te,{p:Y[1],rank:2}),o.jsx(te,{p:Y[0],rank:1}),o.jsx(te,{p:Y[2],rank:3})]}),fe.length>0?o.jsxs("div",{style:{borderRadius:16,overflow:"hidden",border:"1px solid #E2E8F0",background:"#FFFFFF",marginBottom:20,boxShadow:"0 4px 16px rgba(15,23,42,0.03)"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",padding:e?"12px 14px":"12px 20px",background:"#F8FAF8",borderBottom:"1px solid #E2E8F0",color:"#64748B",fontSize:11,fontWeight:800,textTransform:"uppercase",letterSpacing:.5},children:[o.jsx("div",{style:{width:34},children:"#"}),o.jsx("div",{style:{flex:1},children:"Player"}),o.jsx("div",{style:{width:80,textAlign:"center"},children:"Role"}),o.jsx("div",{style:{width:70,textAlign:"center"},children:"Matches"}),o.jsx("div",{style:{width:80,textAlign:"right"},children:"Points"}),o.jsx("div",{style:{width:24}})]}),fe.map((g,v)=>{const R=T?q.findIndex(O=>O.id===g.id)+1:v+4,E=g.id===t,ne=R<=10;return o.jsxs("div",{onClick:()=>B(g),style:{display:"flex",alignItems:"center",padding:e?"11px 14px":"12px 20px",background:E?"rgba(34,197,94,0.07)":"#FFFFFF",borderTop:"1px solid #F1F5F9",cursor:"pointer",transition:"background 150ms ease",position:"relative"},onMouseEnter:O=>{E||(O.currentTarget.style.background="#F8FAF8")},onMouseLeave:O=>{E||(O.currentTarget.style.background="#FFFFFF")},children:[o.jsx("div",{style:{width:34,flexShrink:0},children:ne?o.jsx("span",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:22,height:22,borderRadius:6,background:"#F1F5F9",color:"#0F172A",fontSize:11,fontWeight:900,fontFamily:"var(--font-head)"},children:R}):o.jsx("span",{style:{fontSize:13,fontWeight:700,color:"#94A3B8",fontFamily:"var(--font-head)"},children:R})}),o.jsxs("div",{style:{flex:1,display:"flex",alignItems:"center",gap:10,minWidth:0},children:[g.profile_image_url?o.jsx("img",{src:g.profile_image_url,alt:g.name,style:{width:34,height:34,borderRadius:"50%",objectFit:"cover",flexShrink:0,border:"1.5px solid #E2E8F0"}}):o.jsx(U,{name:g.name,id:g.id,sz:34}),o.jsxs("div",{style:{minWidth:0},children:[o.jsxs("div",{style:{fontWeight:800,fontSize:13.5,color:"#0F172A",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",display:"flex",alignItems:"center",gap:6},children:[o.jsx("span",{children:g.name}),E&&o.jsx("span",{style:{background:"#166534",color:"#FFFFFF",fontSize:9,fontWeight:900,padding:"1px 6px",borderRadius:4},children:"YOU"})]}),g.city&&o.jsxs("div",{style:{fontSize:11,color:"#94A3B8",marginTop:1},children:["📍 ",g.city]})]})]}),o.jsx("div",{style:{width:80,textAlign:"center",flexShrink:0},children:g.role&&g.role!=="player"?o.jsx(Fe,{role:g.role,size:"sm"}):o.jsx("span",{style:{fontSize:10,fontWeight:800,background:"rgba(22,101,52,0.08)",color:"#166534",padding:"2px 7px",borderRadius:4},children:"Player"})}),o.jsx("div",{style:{width:70,textAlign:"center",fontSize:13,fontWeight:800,color:"#0F172A",flexShrink:0},children:g.matchesPlayed}),o.jsxs("div",{style:{width:80,textAlign:"right",fontSize:14,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)",flexShrink:0},children:[g.points," ",o.jsx("span",{style:{fontSize:9.5,fontWeight:700,color:"#94A3B8"},children:"PTS"})]}),o.jsx("div",{style:{width:24,display:"flex",justifyContent:"flex-end",flexShrink:0},children:o.jsx(Pe,{size:15,color:"#CBD5E1"})})]},g.id)})]}):T?o.jsx(K,{style:{padding:"32px 16px",textAlign:"center",borderRadius:14},children:o.jsxs("div",{style:{fontSize:13.5,color:"#64748B"},children:['No ranked players match "',$,'".']})}):null,V>=0&&o.jsxs("div",{style:{padding:"14px 18px",display:"flex",alignItems:"center",gap:14,background:"linear-gradient(135deg, rgba(22,101,52,0.08), rgba(22,101,52,0.02))",border:"1.5px solid rgba(22,101,52,0.3)",borderRadius:16,boxShadow:"0 4px 14px rgba(22,101,52,0.08)"},children:[o.jsx("div",{style:{width:42,height:42,borderRadius:"50%",background:"#166534",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,boxShadow:"0 2px 8px rgba(22,101,52,0.3)"},children:o.jsx(Ce,{size:20,color:"#FFFFFF"})}),o.jsxs("div",{style:{flex:1,minWidth:0},children:[o.jsx("div",{style:{fontSize:12,color:"#166534",fontWeight:800,textTransform:"uppercase",letterSpacing:.5},children:"Your Season Ranking"}),o.jsxs("div",{style:{fontSize:17,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)",marginTop:2},children:["Rank #",V+1," ",o.jsxs("span",{style:{fontSize:12,fontWeight:600,color:"#64748B"},children:["of ",q.length," players"]})]})]}),o.jsxs("div",{style:{textAlign:"right",flexShrink:0},children:[o.jsxs("div",{style:{fontSize:20,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)"},children:[q[V].points," ",o.jsx("span",{style:{fontSize:11,fontWeight:700,color:"#94A3B8"},children:"PTS"})]}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:1},children:[q[V].matchesPlayed," matches played"]})]})]})]})),k&&o.jsx("div",{onClick:()=>B(null),style:{position:"fixed",inset:0,background:"rgba(15,23,42,0.5)",backdropFilter:"blur(4px)",zIndex:400,display:"flex",alignItems:"center",justifyContent:"center",padding:16},children:o.jsxs("div",{onClick:g=>g.stopPropagation(),style:{background:"#FFFFFF",borderRadius:20,maxWidth:440,width:"100%",padding:22,boxShadow:"0 24px 60px rgba(15,23,42,0.3)",maxHeight:"90vh",display:"flex",flexDirection:"column"},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:14},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12},children:[k.profile_image_url?o.jsx("img",{src:k.profile_image_url,alt:k.name,style:{width:50,height:50,borderRadius:"50%",objectFit:"cover",border:"2px solid #166534"}}):o.jsx(U,{name:k.name,id:k.id,sz:50}),o.jsxs("div",{children:[o.jsx("h3",{style:{margin:0,fontSize:16,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)"},children:k.name}),o.jsxs("div",{style:{fontSize:12,color:"#64748B",display:"flex",alignItems:"center",gap:6,marginTop:2},children:[o.jsx("span",{children:k.city||"Pune"}),o.jsx("span",{children:"·"}),o.jsx("span",{style:{fontWeight:700,color:"#166534"},children:k.role||"Player"})]})]})]}),o.jsx("button",{onClick:()=>B(null),style:{background:"none",border:"none",fontSize:22,cursor:"pointer",color:"#94A3B8",padding:0},children:"×"})]}),o.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:16,background:"#F8FAF8",padding:12,borderRadius:12,border:"1px solid #E2E8F0",textAlign:"center"},children:[o.jsxs("div",{children:[o.jsx("div",{style:{fontSize:10,color:"#94A3B8",fontWeight:700,textTransform:"uppercase"},children:"Rank"}),o.jsxs("div",{style:{fontSize:16,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)",marginTop:2},children:["#",q.findIndex(g=>g.id===k.id)+1]})]}),o.jsxs("div",{children:[o.jsx("div",{style:{fontSize:10,color:"#94A3B8",fontWeight:700,textTransform:"uppercase"},children:"Matches"}),o.jsx("div",{style:{fontSize:16,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)",marginTop:2},children:k.matchesPlayed})]}),o.jsxs("div",{children:[o.jsx("div",{style:{fontSize:10,color:"#94A3B8",fontWeight:700,textTransform:"uppercase"},children:"Points"}),o.jsx("div",{style:{fontSize:16,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)",marginTop:2},children:k.points})]})]}),o.jsxs("div",{style:{fontSize:12,fontWeight:800,color:"#0F172A",marginBottom:8,textTransform:"uppercase",letterSpacing:.3},children:["Verified Completed Matches (",((me=k.matches)==null?void 0:me.length)||0,")"]}),o.jsx("div",{style:{flex:1,overflowY:"auto",display:"grid",gap:8,paddingRight:2,maxHeight:240},children:(k.matches||[]).map((g,v)=>o.jsxs("div",{style:{padding:"9px 12px",background:"#F8FAF8",borderRadius:10,border:"1px solid #E2E8F0",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[o.jsxs("div",{style:{minWidth:0},children:[o.jsxs("div",{style:{fontSize:12.5,fontWeight:800,color:"#0F172A",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:[g.our_team||"Team"," vs ",g.team||"Opponent"]}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:1},children:["📅 ",g.date||"Completed"]})]}),o.jsx("span",{style:{fontSize:11,fontWeight:800,color:"#166534",background:"#DCFCE7",padding:"2px 7px",borderRadius:6,flexShrink:0},children:"+20 PTS"})]},v))}),o.jsx("button",{onClick:()=>B(null),style:{width:"100%",padding:"11px",borderRadius:10,background:"#166534",border:"none",color:"#FFFFFF",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"var(--font-head)",marginTop:16},children:"Close"})]})})]})}function Ir({player:e}){const[t,a]=_.useState(null),[n,r]=_.useState(!0),[s,l]=_.useState(!1),[d,c]=_.useState(!1);_.useEffect(()=>{Be(e.id).then(a).catch(()=>{}).finally(()=>r(!1))},[e.id]);const u=async()=>{l(!0);try{const b=await qe(e.id);a(b)}catch(b){alert(b.message)}l(!1)},p=async()=>{if(t!=null&&t.id){c(!0);try{await $e(t.id),a(null)}catch(b){alert(b.message)}c(!1)}};if(e.role==="pro"||n)return null;const f=t==null?void 0:t.status;return o.jsxs(K,{style:{padding:"16px",marginTop:16},children:[o.jsxs("div",{style:{fontWeight:700,fontSize:14,color:"#0F172A",marginBottom:8,fontFamily:"var(--font-head)",display:"flex",alignItems:"center",gap:8},children:[o.jsx(ye,{size:17,color:"#166534"})," Schedule Your Own Matches"]}),o.jsx("div",{style:{fontSize:12,color:"#64748B",marginBottom:12,lineHeight:1.5},children:"Scheduling matches is a Pro feature. Request access below — once approved by your admin, you'll be able to schedule your own matches for 60 days."}),f==="pending"?o.jsxs(o.Fragment,{children:[o.jsx("div",{style:{padding:"10px 12px",background:"rgba(216,176,91,0.1)",borderRadius:10,color:"#B8860B",fontSize:12,fontWeight:700,textAlign:"center",marginBottom:10},children:"⏳ Your request is pending admin approval"}),o.jsx("button",{onClick:p,disabled:d,style:{width:"100%",padding:"9px",borderRadius:10,background:"transparent",border:"1.5px solid #E2E8F0",color:"#64748B",fontSize:12,cursor:"pointer",fontWeight:700,fontFamily:"var(--font-body)"},children:d?"Cancelling...":"Cancel Request"})]}):o.jsx("button",{onClick:u,disabled:s,style:{width:"100%",padding:"11px",borderRadius:10,background:"linear-gradient(135deg,#166534,#FFFFFF)",border:"none",color:"#0F172A",fontSize:13,cursor:"pointer",fontWeight:700,fontFamily:"var(--font-head)",display:"flex",alignItems:"center",justifyContent:"center",gap:8},children:s?"Sending...":f==="rejected"?"Request Again":o.jsxs(o.Fragment,{children:[o.jsx(ye,{size:15})," Request to Schedule Matches"]})})]})}const ue="ss_session";function Yn(e,t=null){try{localStorage.setItem(ue,JSON.stringify({role:e,player:t}))}catch{}}function Vn(){try{return JSON.parse(localStorage.getItem(ue)||"null")}catch{return null}}function Ve(){try{localStorage.removeItem(ue)}catch{}}class Kn extends _.Component{constructor(t){super(t),this.state={hasError:!1,isChunkError:!1}}static getDerivedStateFromError(t){const a=((t==null?void 0:t.message)||(t==null?void 0:t.toString())||"").toLowerCase();return{hasError:!0,isChunkError:/dynamically imported|loading chunk|failed to fetch|chunkloaderror|import/i.test(a)}}componentDidCatch(t,a){console.error("SelectedSports App Error caught by boundary:",t,a);const n=((t==null?void 0:t.message)||(t==null?void 0:t.toString())||"").toLowerCase();if(/dynamically imported|loading chunk|failed to fetch|chunkloaderror|import/i.test(n)){const r=parseInt(sessionStorage.getItem("boundary_reload_ts")||"0",10);if(Date.now()-r>6e3){sessionStorage.setItem("boundary_reload_ts",String(Date.now()));const s=new URL(window.location.href);s.searchParams.set("_v",String(Date.now())),window.location.replace(s.toString())}}}render(){return this.state.hasError?this.state.isChunkError?o.jsxs("div",{style:{minHeight:"100vh",background:"#F8FAF8",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,textAlign:"center"},children:[o.jsx(G,{}),o.jsx("p",{style:{marginTop:16,fontSize:13,color:"#64748B",fontWeight:600,fontFamily:"var(--font-head)"},children:"Updating application..."})]}):o.jsxs("div",{style:{minHeight:"100vh",background:"#F8FAF8",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,textAlign:"center",fontFamily:"var(--font-body)"},children:[o.jsx("div",{style:{width:64,height:64,borderRadius:"50%",background:"rgba(22,101,52,0.1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:32,marginBottom:16},children:"🏏"}),o.jsx("h2",{style:{fontSize:20,fontWeight:900,color:"#0F172A",margin:"0 0 8px",fontFamily:"var(--font-head)"},children:"Selected Sports"}),o.jsx("p",{style:{fontSize:13,color:"#64748B",maxWidth:360,margin:"0 0 20px",lineHeight:1.5},children:"Something unexpected happened. Tap below to reload."}),o.jsxs("div",{style:{display:"flex",gap:10,flexWrap:"wrap",justifyContent:"center"},children:[o.jsx("button",{onClick:()=>window.location.reload(),style:{padding:"12px 22px",borderRadius:12,background:"#166534",color:"#FFFFFF",border:"none",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"var(--font-head)"},children:"🔄 Reload App"}),o.jsx("button",{onClick:()=>{Ve(),localStorage.clear(),window.location.href="/"},style:{padding:"12px 18px",borderRadius:12,background:"#FFFFFF",color:"#64748B",border:"1.5px solid #E2E8F0",fontSize:13,fontWeight:700,cursor:"pointer"},children:"Return to Home"})]})]}):this.props.children}}function L(e){return _.lazy(async()=>{try{return await e()}catch(t){console.warn("Chunk load failed, auto-reloading to fetch new version:",t);const a=parseInt(sessionStorage.getItem("chunk_reload_ts")||"0",10),n=Date.now();if(n-a>8e3){sessionStorage.setItem("chunk_reload_ts",String(n));const r=new URL(window.location.href);return r.searchParams.set("_v",String(n)),window.location.replace(r.toString()),new Promise(()=>{})}throw t}})}const Zn=L(()=>D(()=>import("./LoginScreens-DNMgk5nS.js"),__vite__mapDeps([0,1,2,3])).then(e=>({default:e.UnifiedLoginScreen}))),Jn=L(()=>D(()=>import("./LoginScreens-DNMgk5nS.js"),__vite__mapDeps([0,1,2,3])).then(e=>({default:e.RegisterScreen}))),Qn=L(()=>D(()=>import("./LoginScreens-DNMgk5nS.js"),__vite__mapDeps([0,1,2,3])).then(e=>({default:e.RegistrationSubmittedScreen}))),Xn=L(()=>D(()=>import("./AdminPortal-CwdsZtRc.js").then(e=>e.A),__vite__mapDeps([4,1,5,2,6,3]))),er=L(()=>D(()=>import("./PlayerPortal-D00NAt-s.js"),__vite__mapDeps([6,1,2,3]))),tr=L(()=>D(()=>import("./ProPortal-CYYtal5b.js"),__vite__mapDeps([7,1,2,4,5,6,3]))),ar=L(()=>D(()=>import("./PublicInvitePage-DTvB-KD4.js"),__vite__mapDeps([8,1,3]))),nr=L(()=>D(()=>import("./PublicAuctionView-nMNYwaCJ.js"),__vite__mapDeps([9,1,3]))),rr=L(()=>D(()=>import("./PublicAuctionRegister-iTY4YeRU.js"),__vite__mapDeps([10,1,2,5,3]))),or=L(()=>D(()=>import("./TeamOwnerView-BorZAjQ8.js"),__vite__mapDeps([11,1,3])));function ee(){const t=new URLSearchParams(window.location.search).get("p");t&&window.history.replaceState(null,"",t)}function ir(){ee();const t=window.location.pathname.match(/\/join\/([a-zA-Z0-9\-]+)/);return t?t[1]:null}function sr(){ee();const e=window.location.pathname.match(/\/live-auction(?:\/([a-zA-Z0-9\-]+))?\/?$/);return e?e[1]||null:void 0}function lr(){ee();const e=window.location.pathname.match(/\/auction-register(?:\/([a-zA-Z0-9\-]+))?\/?$/);return e?e[1]||null:void 0}function cr(){ee();const e=window.location.pathname.match(/\/team-view\/([a-zA-Z0-9\-]+)\/([a-zA-Z0-9\-]+)\/?$/);return e?{auctionCode:e[1],teamId:e[2]}:null}function dr(){const[e,t]=_.useState("home"),[a,n]=_.useState(null),[r,s]=_.useState(!1),[l,d]=_.useState([]),[c,u]=_.useState(!1),[p,f]=_.useState(null),[b,y]=_.useState(null),[m,h]=_.useState(null),[w,C]=_.useState(null);_.useEffect(()=>{const k=cr();if(k){C(k),t("teamView");return}const B=sr();if(B!==void 0){y(B),t("liveAuction");return}const W=lr();if(W!==void 0){h(W),t("auctionRegister");return}const N=ir();if(N){f(N),t("publicInvite");return}const j=Vn();(j==null?void 0:j.role)==="admin"||(j==null?void 0:j.role)==="founder"?(s(!0),n(j.player),t("portal")):(j==null?void 0:j.role)==="organizer"&&(j!=null&&j.player)?(s(!0),P(!0),n(j.player),t("portal")):(j==null?void 0:j.role)==="pro"&&(j!=null&&j.player)?(s(!1),S(!0),n(j.player),t("portal")):(j==null?void 0:j.role)==="player"&&(j!=null&&j.player)&&(s(!1),n(j.player),x().then(()=>t("portal")))},[]);const x=async()=>{u(!0);try{d(await Ae())}catch{}u(!1)},[F,S]=_.useState(!1),[z,P]=_.useState(!1),$=async k=>{const B=(k.phone||"").replace(/[^0-9]/g,"").slice(-10),W=Dn.replace(/[^0-9]/g,"").slice(-10);console.log("phone:",B,"adminPhone:",W);const N=B===W||k.role==="founder",j=!N&&k.role==="organizer",q=N||j,T=!q&&k.role==="pro";s(q),P(j),S(T),n(k),q||await x(),Yn(N?"founder":j?"organizer":T?"pro":"player",k),t("portal")},A=()=>{Ve(),n(null),s(!1),S(!1),P(!1),d([]),t("home")};return o.jsx(Kn,{children:o.jsxs(_.Suspense,{fallback:o.jsx("div",{style:{minHeight:"100vh",background:"#0F172A",display:"flex",alignItems:"center",justifyContent:"center"},children:o.jsx(G,{})}),children:[e==="publicInvite"&&o.jsx(ar,{token:p}),e==="liveAuction"&&o.jsx(nr,{auctionCode:b}),e==="teamView"&&o.jsx(or,{auctionCode:w==null?void 0:w.auctionCode,teamId:w==null?void 0:w.teamId}),e==="auctionRegister"&&o.jsx(rr,{auctionCode:m}),e==="home"&&o.jsx(In,{onLogin:()=>t("login"),onRegister:()=>t("register")}),e==="register"&&o.jsx(Jn,{onSuccess:()=>t("registered"),onBack:()=>t("home")}),e==="registered"&&o.jsx(Qn,{onBack:()=>t("home")}),e==="login"&&o.jsx(Zn,{onAdminSuccess:$,onPlayerSuccess:$,onBack:()=>t("home"),onRegister:()=>t("register")}),e==="portal"&&r&&o.jsx(Xn,{player:a,onLogout:A,isFounder:!z}),e==="portal"&&!r&&F&&o.jsx(tr,{player:a,onLogout:A}),e==="portal"&&!r&&!F&&(c||!a?o.jsx("div",{style:{minHeight:"100vh",background:"#FBF3E7",display:"flex",alignItems:"center",justifyContent:"center"},children:o.jsx(G,{})}):o.jsx(er,{player:a,matches:l,onLogout:A}))]})})}document.documentElement.style.setProperty("background","#F8FAF8","important");document.body.style.setProperty("background","#F8FAF8","important");"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(e=>{e.forEach(t=>t.unregister())}).catch(()=>{});"caches"in window&&caches.keys().then(e=>{e.forEach(t=>caches.delete(t))}).catch(()=>{});async function pe(){try{const e=await fetch("/version.json?_cb="+Date.now(),{cache:"no-store"});if(!e.ok)return;const t=await e.json();if(t!=null&&t.v&&t.v>1789162264707){console.warn("New build detected on server. Reloading to latest:",t.v,">",1789162264707);const a=new URL(window.location.href);a.searchParams.set("_v",String(t.v)),window.location.replace(a.toString())}}catch{}}pe();setInterval(pe,3e4);document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&pe()});window.addEventListener("vite:preloadError",e=>{e.preventDefault(),console.warn("Dynamic import preload error, fetching fresh bundle:",e);const t=parseInt(sessionStorage.getItem("vite_preload_ts")||"0",10);if(Date.now()-t>6e3){sessionStorage.setItem("vite_preload_ts",String(Date.now()));const a=new URL(window.location.href);a.searchParams.set("_v",String(Date.now())),window.location.replace(a.toString())}});window.addEventListener("unhandledrejection",e=>{var a;const t=((a=e.reason)==null?void 0:a.message)||String(e.reason||"");if(/dynamically imported|loading chunk|failed to fetch/i.test(t)){e.preventDefault();const n=parseInt(sessionStorage.getItem("unhandled_chunk_ts")||"0",10);if(Date.now()-n>6e3){sessionStorage.setItem("unhandled_chunk_ts",String(Date.now()));const r=new URL(window.location.href);r.searchParams.set("_v",String(Date.now())),window.location.replace(r.toString())}}});mt.createRoot(document.getElementById("root")).render(o.jsx(gt.StrictMode,{children:o.jsx(dr,{})}));export{wn as $,Dn as A,$r as B,K as C,Wn as D,gr as E,fr as F,$n as G,Xa as H,Cn as I,on as J,ga as K,Tr as L,On as M,na as N,Tt as O,be as P,Mt as Q,Fe as R,G as S,qr as T,Nt as U,Pr as V,Ar as W,Fr as X,Sr as Y,_n as Z,D as _,mr as a,jr as a$,kn as a0,mn as a1,An as a2,ce as a3,Va as a4,Sn as a5,sn as a6,an as a7,ia as a8,fa as a9,It as aA,Ct as aB,Oe as aC,Ye as aD,Cr as aE,Gn as aF,Ma as aG,wr as aH,fn as aI,kt as aJ,En as aK,Aa as aL,un as aM,pn as aN,hr as aO,br as aP,Vt as aQ,cn as aR,Ga as aS,ca as aT,qn as aU,Ra as aV,ea as aW,Kt as aX,tn as aY,Yn as aZ,Un as a_,ta as aa,qt as ab,Pa as ac,Re as ad,Wt as ae,_a as af,ze as ag,Ae as ah,bn as ai,va as aj,jt as ak,ja as al,ra as am,zn as an,za as ao,gn as ap,Fn as aq,$a as ar,ba as as,wa as at,At as au,Fa as av,xa as aw,Jt as ax,St as ay,X as az,yr as b,sa as b0,Ka as b1,Zt as b2,kr as b3,vr as b4,ln as b5,Er as b6,zr as b7,la as b8,i as b9,vn as ba,en as bb,Ht as bc,oa as bd,dn as be,xn as bf,Ja as bg,Ha as bh,Ya as bi,rn as bj,Bt as bk,Gt as bl,Ut as bm,Et as bn,Za as bo,Sa as bp,Lt as bq,vt as br,Ft as bs,Pn as bt,bt as bu,U as c,Hn as d,Rr as e,Br as f,Mn as g,Ir as h,jn as i,ma as j,aa as k,$t as l,ie as m,Ua as n,Dt as o,Rn as p,Ea as q,Xt as r,_r as s,xr as t,We as u,Yt as v,ka as w,yn as x,nn as y,Ot as z};

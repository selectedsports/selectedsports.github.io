...
`,d+="🏆 *Selected Sports Auction Platform*",d}function Mr(e,t){const n=or(e,t);if(!n)return;const a=`https://api.whatsapp.com/send?text=${encodeURIComponent(n)}`;window.open(a,"_blank")}function Wr(e,t){if(!t||t.length===0){alert("No players found in the auction pool to export.");return}const n=m=>String(m??"").replace(/[&<>"']/g,h=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[h]),a=new Date().toLocaleDateString("en-IN",{day:"numeric",month:"long",year:"numeric"}),r=(e==null?void 0:e.name)||"Selected Sports Cricket Auction",s=t.reduce((m,h)=>m+(Number(h.base_price)||0),0);let l=0,d=0,c=0,u=0;t.forEach(m=>{const h=(m.playing_role||"").toLowerCase();h.includes("all")?l++:h.includes("bat")?d++:h.includes("bowl")?c++:(h.includes("keep")||h.includes("wk"))&&u++});const p=t.map((m,h)=>{const w=h+1,k=m.playing_role||"Player",_=k.toLowerCase();let x="role-other",v="🏏";_.includes("all")?(x="role-all",v="🏏"):_.includes("bat")?(x="role-bat",v="⚡"):_.includes("bowl")?(x="role-bowl",v="🎯"):(_.includes("keep")||_.includes("wk"))&&(x="role-keep",v="🧤");const z=(m.name||"?").slice(0,1).toUpperCase(),A=m.profile_image_url?`<img src="${n(m.profile_image_url)}" alt="${n(m.name)}" class="player-photo" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" /><div class="player-initials-fallback" style="display:none;">${n(z)}</div>`:`<div class="player-initials-fallback">${n(z)}</div>`;return`
      <div class="player-card">
        <div class="card-top">
          <span class="lot-badge">#${w<10?"0"+w:w}</span>
          <span class="role-badge ${x}">${v} ${n(k)}</span>
        </div>
...
</html>`,y=window.open("","_blank");if(!y){alert("Please allow pop-ups to open the PDF export.");return}y.document.write(b),y.document.close(),y.onload=()=>{setTimeout(()=>{try{y.print()}catch{}},350)}}function Gr(e,t=1e3){const n=Number(e)||0;return n<t?t:n<2e4?Math.floor(n/1e3)*1e3+1e3:n<6e4?Math.floor(n/2e3)*2e3+2e3:Math.floor(n/3e3)*3e3+3e3}function Ur(e,t=1e3){const n=Number(e)||0;let a;return n>6e4?(a=Math.ceil(n/3e3)*3e3-3e3,a<6e4&&(a=6e4)):n>2e4?(a=Math.ceil(n/2e3)*2e3-2e3,a<2e4&&(a=2e4)):a=Math.ceil(n/1e3)*1e3-1e3,Math.max(t,a)}function ir({size:e=36}){return o.jsx("img",{src:"/logo-icon-v4.png",alt:"Selected Sports",style:{height:e,width:"auto",display:"block"}})}function Hr({size:e=40}){return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10},children:[o.jsx(ir,{size:e}),o.jsxs("div",{children:[o.jsx("div",{style:{color:"#0F172A",fontFamily:"var(--font-head)",fontWeight:700,fontSize:e*.44,letterSpacing:"-0.5px",lineHeight:1.1},children:"Selected"}),o.jsx("div",{style:{color:"#B8860B",fontFamily:"var(--font-head)",fontWeight:600,fontSize:e*.27,letterSpacing:"2.5px",textTransform:"uppercase",lineHeight:1.1},children:"Sports"})]})]})}function H({name:e,id:t,sz:n=34}){return o.jsx("div",{style:{width:n,height:n,borderRadius:"50%",background:Xa(t),display:"flex",alignItems:"center",justifyContent:"center",fontSize:n*.3,fontWeight:700,color:"#0F172A",flexShrink:0,letterSpacing:"-0.5px",fontFamily:"var(--font-head)"},children:er(e)})}const ke={green:{bg:"rgba(25,182,106,0.12)",tx:"rgba(34,197,94,0.15)"},lime:{bg:"rgba(132,204,22,0.12)",tx:"#4D7C0F"},yellow:{bg:"rgba(244,180,0,0.12)",tx:"rgba(246,196,83,0.15)"},red:{bg:"rgba(229,57,53,0.1)",tx:"rgba(231,76,60,0.15)"},blue:{bg:"rgba(37,95,184,0.1)",tx:"#FFFFFF"},teal:{bg:"rgba(20,184,166,0.12)",tx:"#0F766E"},orange:{bg:"rgba(251,146,60,0.12)",tx:"rgba(251,146,60,0.15)"},purple:{bg:"rgba(167,139,250,0.12)",tx:"rgba(91,33,182,0.12)"},gray:{bg:"#F8FAF8",tx:"#F8FAF8"}},Ce={founder:{label:"Founder",icon:Be,bg:"linear-gradient(135deg,#FBBF24,#D4A017)",color:"#FFFFFF"},organizer:{label:"Organizer",icon:xt,bg:"#166534",color:"#FFFFFF"},pro:{label:"PRO",icon:bt,bg:"#FFFFFF",color:"#2563EB",border:"1.5px solid #2563EB"},player:{label:"Player",icon:ze,bg:"#22C55E",color:"#FFFFFF"},guest:{label:"Guest",icon:yt,bg:"#FFFFFF",color:"#64748B",border:"1.5px solid #E2E8F0"}};function Pe({role:e="player",size:t="md"}){const[n,a]=F.useState(!1);F.useEffect(()=>{const l=setTimeout(()=>a(!0),10);return()=>clearTimeout(l)},[]);const r=Ce[e]||Ce.player,s=t==="sm";return o.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:s?4:6,padding:s?"3px 9px":"5px 13px",borderRadius:999,background:r.bg,color:r.color,border:r.border||"none",fontSize:s?10:12,fontWeight:700,fontFamily:"var(--font-body)",boxShadow:"0 2px 6px rgba(15,23,42,0.12)",whiteSpace:"nowrap",opacity:n?1:0,transform:n?"scale(1)":"scale(0.95)",transition:"opacity 250ms, transform 250ms"},children:[o.jsx(r.icon,{size:s?11:13}),r.label]})}function Yr({children:e,col:t="gray"}){const n=ke[t]||ke.gray;return o.jsx("span",{style:{background:n.bg,color:n.tx,borderRadius:6,padding:"3px 9px",fontSize:11,fontWeight:700,whiteSpace:"nowrap",display:"inline-block",fontFamily:"var(--font-head)"},children:e})}function Vr({children:e,onClick:t,variant:n="primary",size:a="md",disabled:r=!1,style:s={}}){const l={border:"none",borderRadius:10,cursor:r?"not-allowed":"pointer",fontWeight:600,fontFamily:"var(--font-body)",display:"inline-flex",alignItems:"center",justifyContent:"center",gap:6,opacity:r?.55:1},d={primary:{background:"linear-gradient(135deg,#166534,#FFFFFF)",color:"#0F172A"},green:{background:"#166534",color:"#0F172A"},danger:{background:"rgba(229,57,53,0.1)",color:"#DC2626",border:"1px solid rgba(229,57,53,0.3)"},ghost:{background:"#F8FAF8",color:"#0F172A"},wa:{background:"rgba(25,182,106,0.12)",color:"#166534",border:"1px solid rgba(25,182,106,0.3)"},outline:{background:"transparent",color:"#166534",border:"1.5px solid #166534"},dark:{background:"#FFFFFF",color:"#0F172A",border:"none"}},c={sm:{padding:"5px 12px",fontSize:12},md:{padding:"9px 18px",fontSize:13},lg:{padding:"12px 24px",fontSize:14}};return o.jsx("button",{onClick:r?void 0:t,style:{...l,...d[n],...c[a],...s},children:e})}function Y(){return o.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",padding:48},children:[o.jsx("div",{style:{width:32,height:32,borderRadius:"50%",border:"3px solid #E2E8F0",borderTopColor:"#166534",animation:"spin 0.7s linear infinite"}}),o.jsx("style",{children:"@keyframes spin{to{transform:rotate(360deg)}}"})]})}function Z({children:e,style:t={},onClick:n}){return o.jsx("div",{onClick:n,style:{background:"#FFFFFF",borderRadius:16,border:"1px solid #E2E8F0",boxShadow:"0 1px 3px rgba(15,23,42,0.05), 0 1px 2px rgba(15,23,42,0.03)",...t},children:e})}function Kr({messages:e,onClose:t,player:n}){const[a,r]=F.useState(""),[s,l]=F.useState(!1),[d,c]=F.useState(!1),[u,p]=F.useState(null),[f,b]=F.useState([]),[y,m]=F.useState(!1),h=async()=>{if(!(!a.trim()||!n)){l(!0);try{const _=await He();_&&(await Ge(n.id,_,a.trim()),c(!0),r(""))}catch(_){alert(_.message)}l(!1)}},w=_=>{const x=_.match(/\[\[match:([a-zA-Z0-9-]+)\]\]/);return{clean:_.replace(/\[\[match:[a-zA-Z0-9-]+\]\]/,"").trim(),matchId:x?x[1]:null}},k=async _=>{p(_),m(!0);try{b(await De(_))}catch(x){alert(x.message)}m(!1)};if(u){const _=f.filter(v=>v.status==="confirmed"),x=f.filter(v=>v.status==="waitlist");return o.jsx("div",{onClick:t,style:{position:"fixed",inset:0,background:"rgba(15,23,42,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:500,padding:16},children:o.jsxs("div",{onClick:v=>v.stopPropagation(),style:{background:"#FFFFFF",border:"1.5px solid #E2E8F0",borderRadius:16,maxWidth:420,width:"100%",maxHeight:"80vh",overflowY:"auto",padding:20,boxShadow:"0 24px 60px rgba(15,23,42,0.35)"},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14},children:[o.jsxs("button",{onClick:()=>p(null),style:{background:"transparent",border:"none",fontSize:13,fontWeight:700,color:"#166534",cursor:"pointer",display:"flex",alignItems:"center",gap:4,padding:0},children:[o.jsx(wt,{size:15})," Back"]}),o.jsx("button",{onClick:t,style:{background:"transparent",border:"none",fontSize:20,cursor:"pointer",color:"#64748B"},children:"×"})]}),y?o.jsx(Y,{}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{style:{fontWeight:700,fontSize:14,color:"#0F172A",marginBottom:10,fontFamily:"var(--font-head)"},children:["Confirmed (",_.length,")"]}),o.jsx("div",{style:{marginBottom:18},children:_.length===0?o.jsx("div",{style:{color:"#94A3B8",fontSize:12},children:"No one confirmed yet."}):_.map(v=>{var z,A;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"7px 0"},children:[o.jsx(H,{name:((z=v.players)==null?void 0:z.name)||"Player",id:v.player_id,sz:28}),o.jsx("span",{style:{fontSize:13,color:"#0F172A",fontWeight:600},children:((A=v.players)==null?void 0:A.name)||"Player"})]},v.id)})}),o.jsxs("div",{style:{fontWeight:700,fontSize:14,color:"#B8860B",marginBottom:10,fontFamily:"var(--font-head)"},children:["Waitlist (",x.length,")"]}),o.jsx("div",{children:x.length===0?o.jsx("div",{style:{color:"#94A3B8",fontSize:12},children:"No one on the waitlist."}):x.map(v=>{var z,A;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"7px 0"},children:[o.jsx(H,{name:((z=v.players)==null?void 0:z.name)||"Player",id:v.player_id,sz:28}),o.jsx("span",{style:{fontSize:13,color:"#0F172A",fontWeight:600},children:((A=v.players)==null?void 0:A.name)||"Player"})]},v.id)})})]})]})})}return o.jsx("div",{onClick:t,style:{position:"fixed",inset:0,background:"rgba(15,23,42,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:500,padding:16},children:o.jsxs("div",{onClick:_=>_.stopPropagation(),style:{background:"#FFFFFF",border:"1.5px solid #E2E8F0",borderRadius:16,maxWidth:420,width:"100%",maxHeight:"80vh",overflowY:"auto",padding:20,boxShadow:"0 24px 60px rgba(15,23,42,0.35)"},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14},children:[o.jsxs("div",{style:{fontWeight:700,fontSize:16,fontFamily:"var(--font-head)",color:"#0F172A",display:"flex",alignItems:"center",gap:8},children:[o.jsx(_t,{size:18})," Messages"]}),o.jsx("button",{onClick:t,style:{background:"transparent",border:"none",fontSize:20,cursor:"pointer",color:"#64748B"},children:"×"})]}),e.length===0&&o.jsx("div",{style:{color:"#64748B",fontSize:13,textAlign:"center",padding:"20px 0"},children:"No messages yet."}),e.map(_=>{const{clean:x,matchId:v}=w(_.message);return o.jsxs("div",{onClick:v?()=>k(v):void 0,style:{padding:"12px 0",borderBottom:"1px solid #E2E8F0",cursor:v?"pointer":"default"},children:[o.jsx("div",{style:{fontSize:13,color:"#0F172A",lineHeight:1.5},children:x}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:5,display:"flex",alignItems:"center",gap:6},children:["From ",_.sender," · ",_.created_at?new Date(_.created_at).toLocaleString():"",v&&o.jsxs("span",{style:{color:"#166534",fontWeight:700,display:"flex",alignItems:"center",gap:2},children:["· View squad ",o.jsx($e,{size:11})]})]})]},_.id)}),n&&o.jsxs("div",{style:{marginTop:14,paddingTop:14,borderTop:"1.5px solid #E2E8F0"},children:[o.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#0F172A",marginBottom:8},children:"Reply to Admin"}),d&&o.jsx("div",{style:{fontSize:12,color:"#166534",marginBottom:8},children:"✓ Sent! Full conversation is in Direct Messages."}),o.jsxs("div",{style:{display:"flex",gap:8},children:[o.jsx("input",{value:a,onChange:_=>r(_.target.value),onKeyDown:_=>_.key==="Enter"&&h(),placeholder:"Type a reply...",style:{flex:1,padding:"9px 12px",borderRadius:9,border:"1.5px solid #E2E8F0",background:"#F8FAF8",color:"#0F172A",fontSize:13,outline:"none",fontFamily:"var(--font-body)"}}),o.jsx("button",{onClick:h,disabled:s,style:{padding:"9px 14px",borderRadius:9,background:"#166534",border:"none",color:"#0F172A",fontSize:13,cursor:"pointer",fontWeight:600},children:s?"...":"Send"})]})]})]})})}function Jr({isMobile:e,myId:t}){var we;const[a,r]=F.useState([]),[s,l]=F.useState(!0),[d,c]=F.useState(null),[u,p]=F.useState(!1),[f,b]=F.useState(!1),[y,m]=F.useState("points"),[h,w]=F.useState("all"),[k,_]=F.useState(!1),[x,v]=F.useState("all"),[z,A]=F.useState(!1),[q,C]=F.useState(""),[E,N]=F.useState(null);if(F.useEffect(()=>{Oe().then(g=>{r(g),setTimeout(()=>p(!0),50),g.length>0&&(b(!0),setTimeout(()=>b(!1),2200))}).catch(g=>c(g.message||String(g))).finally(()=>l(!1))},[]),s)return o.jsx(Y,{});const K=Array.from(new Set(a.map(g=>{var S;return(((S=g.matches)==null?void 0:S.date)||"").slice(0,4)}).filter(Boolean))).sort().reverse(),se=a.filter(g=>{var S,$;return!(h!=="all"&&(((S=g.matches)==null?void 0:S.date)||"").slice(0,4)!==h||x!=="all"&&((($=g.players)==null?void 0:$.role)||"player")!==x)}),B={};se.forEach(g=>{const S=g.players;S&&(B[S.id]||(B[S.id]={id:S.id,name:S.name,city:S.city,role:S.role,profile_image_url:S.profile_image_url,matchesPlayed:0,matches:[],earliestConfirmedAt:g.created_at}),B[S.id].matchesPlayed++,g.matches&&B[S.id].matches.push({...g.matches,confirmedAt:g.created_at}),g.created_at&&(!B[S.id].earliestConfirmedAt||g.created_at<B[S.id].earliestConfirmedAt)&&(B[S.id].earliestConfirmedAt=g.created_at))});const P=Object.values(B).map(g=>({...g,points:g.matchesPlayed*20})).sort((g,S)=>S.points!==g.points?S.points-g.points:g.earliestConfirmedAt?S.earliestConfirmedAt?new Date(g.earliestConfirmedAt)-new Date(S.earliestConfirmedAt):-1:1),T=q.trim().toLowerCase(),W=P.filter(g=>!T||g.name.toLowerCase().includes(T)||(g.city||"").toLowerCase().includes(T)),I=P.slice(0,3),j=T?W:P.slice(3),M=t?P.findIndex(g=>g.id===t):-1,J={1:{title:"👑 MVP · CHAMPION",border:"2px solid #F59E0B",bg:"linear-gradient(180deg, rgba(245,158,11,0.18) 0%, rgba(245,158,11,0.03) 100%)",badgeBg:"linear-gradient(135deg, #F59E0B, #D97706)",glow:"0 10px 28px rgba(245,158,11,0.28)",avatarBorder:"#F59E0B",avatarGlow:"0 0 20px rgba(245,158,11,0.4)"},2:{title:"🥈 2ND PLACE",border:"1.5px solid #CBD5E1",bg:"linear-gradient(180deg, rgba(241,245,249,0.9) 0%, rgba(255,255,255,0.8) 100%)",badgeBg:"linear-gradient(135deg, #94A3B8, #64748B)",glow:"0 8px 20px rgba(100,116,139,0.15)",avatarBorder:"#94A3B8",avatarGlow:"none"},3:{title:"🥉 3RD PLACE",border:"1.5px solid #FDE68A",bg:"linear-gradient(180deg, rgba(254,243,199,0.5) 0%, rgba(255,255,255,0.8) 100%)",badgeBg:"linear-gradient(135deg, #D97706, #B45309)",glow:"0 8px 20px rgba(180,83,9,0.15)",avatarBorder:"#D97706",avatarGlow:"none"}},le=({p:g,rank:S})=>{if(!g)return o.jsx("div",{style:{flex:1}});const $=J[S],R=S===1;return o.jsxs("div",{onClick:()=>N(g),style:{flex:1,display:"flex",flexDirection:"column",alignItems:"center",cursor:"pointer",opacity:u?1:0,transform:u?R?"translateY(-6px) scale(1.02)":"translateY(0) scale(1)":"translateY(24px) scale(0.95)",transition:`all 350ms cubic-bezier(0.16, 1, 0.3, 1) ${S===1?200:S===2?100:0}ms`,zIndex:R?3:2},children:[R&&o.jsxs("div",{style:{background:$.badgeBg,color:"#FFFFFF",fontSize:10,fontWeight:900,padding:"4px 12px",borderRadius:999,display:"inline-flex",alignItems:"center",gap:5,marginBottom:8,boxShadow:"0 4px 12px rgba(245,158,11,0.4)",letterSpacing:.5,fontFamily:"var(--font-head)"},children:[o.jsx(Be,{size:12,fill:"#FFFFFF"})," MVP · RANK 1"]}),o.jsxs("div",{style:{position:"relative",padding:R?e?"18px 10px 16px":"24px 16px 20px":e?"14px 8px 12px":"18px 12px 16px",borderRadius:20,background:$.bg,border:$.border,width:"100%",textAlign:"center",boxShadow:$.glow,boxSizing:"border-box"},children:[o.jsxs("div",{style:{position:"relative",display:"inline-block",marginBottom:10},children:[o.jsx("div",{style:{borderRadius:"50%",boxShadow:$.avatarGlow,padding:2,background:"#FFFFFF",border:`2px solid ${$.avatarBorder}`},children:g.profile_image_url?o.jsx("img",{src:g.profile_image_url,alt:g.name,style:{width:R?e?54:68:e?42:52,height:R?e?54:68:e?42:52,borderRadius:"50%",objectFit:"cover",display:"block"}}):o.jsx(H,{name:g.name,id:g.id,sz:R?e?54:68:e?42:52})}),o.jsx("div",{style:{position:"absolute",bottom:-4,right:-4,width:R?24:20,height:R?24:20,borderRadius:"50%",background:$.badgeBg,color:"#FFFFFF",fontSize:R?12:10,fontWeight:900,display:"flex",alignItems:"center",justifyContent:"center",border:"2px solid #FFFFFF",boxShadow:"0 2px 6px rgba(0,0,0,0.2)"},children:S})]}),o.jsx("div",{style:{fontWeight:800,fontSize:R?e?13:15:e?12:13,color:"#0F172A",fontFamily:"var(--font-head)",lineHeight:1.2,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:g.name}),o.jsxs("div",{style:{marginTop:4,display:"flex",justifyContent:"center",alignItems:"center",gap:4},children:[g.role&&g.role!=="player"?o.jsx(Pe,{role:g.role,size:"sm"}):o.jsx("span",{style:{fontSize:9.5,fontWeight:800,background:"rgba(22,101,52,0.1)",color:"#166534",padding:"1px 6px",borderRadius:4},children:"PLAYER"}),g.city&&!e&&o.jsxs("span",{style:{fontSize:10,color:"#94A3B8"},children:["· ",g.city]})]}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:4,fontWeight:600},children:[g.matchesPlayed," Matches"]}),o.jsxs("div",{style:{fontSize:R?e?18:22:e?15:18,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)",marginTop:4,display:"flex",alignItems:"center",justifyContent:"center",gap:3},children:[o.jsx("span",{children:g.points}),o.jsx("span",{style:{fontSize:10,fontWeight:800,color:"#94A3B8"},children:"PTS"})]})]})]})},ot=({i:g})=>{const S=["#F59E0B","#166534","#22C55E","#FBBF24","#3B82F6"],$=Math.random()*100,R=Math.random()*300,de=1200+Math.random()*600,G=Math.random()*360,it=S[g%S.length];return o.jsx("div",{style:{position:"absolute",top:-10,left:$+"%",width:8,height:8,background:it,borderRadius:g%2===0?"50%":2,animation:`confettiFall ${de}ms ease-in ${R}ms forwards`,transform:`rotate(${G}deg)`}})},ce=({label:g,desc:S})=>o.jsxs(Z,{style:{padding:"44px 20px",textAlign:"center",borderRadius:16},children:[o.jsx("div",{style:{width:56,height:56,borderRadius:"50%",background:"#F8FAF8",border:"1.5px solid #E2E8F0",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 14px"},children:o.jsx(Fe,{size:26,color:"#94A3B8"})}),o.jsxs("div",{style:{fontWeight:900,fontSize:16,color:"#0F172A",marginBottom:6,fontFamily:"var(--font-head)"},children:[g," Leaderboard Coming Soon"]}),o.jsx("div",{style:{color:"#64748B",fontSize:13,maxWidth:360,margin:"0 auto",lineHeight:1.5},children:S||"Individual batting and bowling statistics will populate automatically once ball-by-ball live match scoring is active."})]});return o.jsxs("div",{style:{position:"relative"},children:[o.jsx("style",{children:`
        @keyframes confettiFall {
          0% { opacity: 1; transform: translateY(0) rotate(0deg); }
          100% { opacity: 0; transform: translateY(260px) rotate(320deg); }
        }
      `}),f&&o.jsx("div",{style:{position:"absolute",top:0,left:0,right:0,height:260,overflow:"hidden",pointerEvents:"none",zIndex:10},children:Array.from({length:36}).map((g,S)=>o.jsx(ot,{i:S},S))}),o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:e?"flex-start":"center",marginBottom:16,gap:12,flexDirection:e?"column":"row",flexWrap:"wrap"},children:[o.jsx("div",{children:o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[o.jsx("div",{style:{width:38,height:38,borderRadius:10,background:"linear-gradient(135deg, rgba(245,158,11,0.15), rgba(22,101,52,0.1))",border:"1px solid rgba(245,158,11,0.3)",display:"flex",alignItems:"center",justifyContent:"center"},children:o.jsx(Ee,{size:20,color:"#D97706"})}),o.jsxs("div",{children:[o.jsx("h2",{style:{fontFamily:"var(--font-head)",color:"#0F172A",fontSize:e?19:22,margin:0,fontWeight:900,letterSpacing:"-0.4px"},children:"Player Leaderboard"}),o.jsx("div",{style:{fontSize:11.5,color:"#64748B",marginTop:2},children:"Official community rankings calculated from verified match appearances (20 PTS / Match)"})]})]})}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,width:e?"100%":"auto",flexWrap:"wrap"},children:[o.jsxs("div",{style:{position:"relative"},children:[o.jsxs("button",{type:"button",onClick:()=>{_(g=>!g),A(!1)},style:{padding:"8px 12px",borderRadius:10,border:"1.5px solid #E2E8F0",background:"#FFFFFF",color:"#0F172A",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6},children:[o.jsx(ft,{size:13,color:"#166534"}),o.jsx("span",{children:h==="all"?"All Seasons":`Season ${h}`}),o.jsx(_e,{size:13,color:"#94A3B8"})]}),k&&o.jsxs("div",{style:{position:"absolute",top:"100%",right:0,marginTop:4,background:"#FFFFFF",border:"1px solid #E2E8F0",borderRadius:10,boxShadow:"0 10px 30px rgba(15,23,42,0.15)",zIndex:30,minWidth:140,overflow:"hidden"},children:[o.jsx("button",{type:"button",onClick:()=>{w("all"),_(!1)},style:{width:"100%",padding:"10px 14px",border:"none",background:h==="all"?"rgba(34,197,94,0.08)":"none",textAlign:"left",fontSize:12.5,color:"#0F172A",cursor:"pointer",fontWeight:h==="all"?800:500},children:"All Seasons"}),K.map(g=>o.jsxs("button",{type:"button",onClick:()=>{w(g),_(!1)},style:{width:"100%",padding:"10px 14px",border:"none",background:h===g?"rgba(34,197,94,0.08)":"none",textAlign:"left",fontSize:12.5,color:"#0F172A",cursor:"pointer",fontWeight:h===g?800:500},children:["Season ",g]},g))]})]}),o.jsxs("div",{style:{position:"relative"},children:[o.jsxs("button",{type:"button",onClick:()=>{A(g=>!g),_(!1)},style:{padding:"8px 12px",borderRadius:10,border:"1.5px solid #E2E8F0",background:"#FFFFFF",color:"#0F172A",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6},children:[o.jsx("span",{children:x==="all"?"All Players":x==="pro"?"PRO Only":"Players Only"}),o.jsx(_e,{size:13,color:"#94A3B8"})]}),z&&o.jsx("div",{style:{position:"absolute",top:"100%",right:0,marginTop:4,background:"#FFFFFF",border:"1px solid #E2E8F0",borderRadius:10,boxShadow:"0 10px 30px rgba(15,23,42,0.15)",zIndex:30,minWidth:140,overflow:"hidden"},children:[["all","All Players"],["player","Players Only"],["pro","PRO Only"]].map(([g,S])=>o.jsx("button",{type:"button",onClick:()=>{v(g),A(!1)},style:{width:"100%",padding:"10px 14px",border:"none",background:x===g?"rgba(34,197,94,0.08)":"none",textAlign:"left",fontSize:12.5,color:"#0F172A",cursor:"pointer",fontWeight:x===g?800:500},children:S},g))})]})]})]}),o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:10,marginBottom:18,flexDirection:e?"column":"row"},children:[o.jsx("div",{style:{display:"flex",gap:8,overflowX:"auto",width:e?"100%":"auto",paddingBottom:2},children:[["points","Points Table",mt],["runs","Most Runs",Fe],["wickets","Most Wickets",gt],["sixes","Most 6s",Re]].map(([g,S,$])=>o.jsxs("button",{type:"button",onClick:()=>m(g),style:{padding:"8px 14px",borderRadius:999,border:y===g?"none":"1.5px solid #E2E8F0",background:y===g?"#166534":"#FFFFFF",color:y===g?"#FFFFFF":"#64748B",fontSize:12,fontWeight:800,cursor:"pointer",display:"flex",alignItems:"center",gap:6,whiteSpace:"nowrap",flexShrink:0,boxShadow:y===g?"0 2px 8px rgba(22,101,52,0.25)":"none",transition:"all 150ms ease"},children:[o.jsx($,{size:13}),o.jsx("span",{children:S})]},g))}),y==="points"&&o.jsxs("div",{style:{width:e?"100%":240,position:"relative"},children:[o.jsx(ht,{size:14,color:"#94A3B8",style:{position:"absolute",left:12,top:"50%",transform:"translateY(-50%)"}}),o.jsx("input",{type:"text",value:q,onChange:g=>C(g.target.value),placeholder:"Search ranked player...",style:{width:"100%",padding:"8px 12px 8px 32px",borderRadius:999,border:"1.5px solid #E2E8F0",fontSize:12,outline:"none",background:"#FFFFFF",boxSizing:"border-box",fontFamily:"var(--font-body)"}})]})]}),y==="runs"&&o.jsx(ce,{label:"Most Runs",desc:"Track top batsmen across tournaments once live match scoring is recorded."}),y==="wickets"&&o.jsx(ce,{label:"Most Wickets",desc:"Track top wicket-takers across matches once match scorecards are submitted."}),y==="sixes"&&o.jsx(ce,{label:"Most 6s",desc:"Track maximum sixes hit per season once live innings balls are captured."}),y==="points"&&(d?o.jsxs("div",{style:{color:"#EF4444",fontSize:13,textAlign:"center",padding:"30px 0",background:"rgba(239,68,68,0.06)",borderRadius:12,border:"1px solid rgba(239,68,68,0.25)"},children:["⚠️ Couldn't load the leaderboard: ",d]}):P.length===0?o.jsx(Z,{style:{padding:"40px 20px",textAlign:"center",borderRadius:16},children:o.jsxs("div",{style:{fontSize:14,color:"#64748B"},children:["No completed matches recorded yet",h!=="all"?` for Season ${h}`:"","."]})}):o.jsxs(o.Fragment,{children:[!T&&I.length>0&&o.jsxs("div",{style:{display:"flex",alignItems:"stretch",gap:e?8:14,marginBottom:22,padding:"0 2px"},children:[o.jsx(le,{p:I[1],rank:2}),o.jsx(le,{p:I[0],rank:1}),o.jsx(le,{p:I[2],rank:3})]}),j.length>0?o.jsxs("div",{style:{borderRadius:16,overflow:"hidden",border:"1px solid #E2E8F0",background:"#FFFFFF",marginBottom:20,boxShadow:"0 4px 16px rgba(15,23,42,0.03)"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",padding:e?"12px 14px":"12px 20px",background:"#F8FAF8",borderBottom:"1px solid #E2E8F0",color:"#64748B",fontSize:11,fontWeight:800,textTransform:"uppercase",letterSpacing:.5},children:[o.jsx("div",{style:{width:34},children:"#"}),o.jsx("div",{style:{flex:1},children:"Player"}),o.jsx("div",{style:{width:80,textAlign:"center"},children:"Role"}),o.jsx("div",{style:{width:70,textAlign:"center"},children:"Matches"}),o.jsx("div",{style:{width:80,textAlign:"right"},children:"Points"}),o.jsx("div",{style:{width:24}})]}),j.map((g,S)=>{const $=T?P.findIndex(G=>G.id===g.id)+1:S+4,R=g.id===t,de=$<=10;return o.jsxs("div",{onClick:()=>N(g),style:{display:"flex",alignItems:"center",padding:e?"11px 14px":"12px 20px",background:R?"rgba(34,197,94,0.07)":"#FFFFFF",borderTop:"1px solid #F1F5F9",cursor:"pointer",transition:"background 150ms ease",position:"relative"},onMouseEnter:G=>{R||(G.currentTarget.style.background="#F8FAF8")},onMouseLeave:G=>{R||(G.currentTarget.style.background="#FFFFFF")},children:[o.jsx("div",{style:{width:34,flexShrink:0},children:de?o.jsx("span",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:22,height:22,borderRadius:6,background:"#F1F5F9",color:"#0F172A",fontSize:11,fontWeight:900,fontFamily:"var(--font-head)"},children:$}):o.jsx("span",{style:{fontSize:13,fontWeight:700,color:"#94A3B8",fontFamily:"var(--font-head)"},children:$})}),o.jsxs("div",{style:{flex:1,display:"flex",alignItems:"center",gap:10,minWidth:0},children:[g.profile_image_url?o.jsx("img",{src:g.profile_image_url,alt:g.name,style:{width:34,height:34,borderRadius:"50%",objectFit:"cover",flexShrink:0,border:"1.5px solid #E2E8F0"}}):o.jsx(H,{name:g.name,id:g.id,sz:34}),o.jsxs("div",{style:{minWidth:0},children:[o.jsxs("div",{style:{fontWeight:800,fontSize:13.5,color:"#0F172A",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",display:"flex",alignItems:"center",gap:6},children:[o.jsx("span",{children:g.name}),R&&o.jsx("span",{style:{background:"#166534",color:"#FFFFFF",fontSize:9,fontWeight:900,padding:"1px 6px",borderRadius:4},children:"YOU"})]}),g.city&&o.jsxs("div",{style:{fontSize:11,color:"#94A3B8",marginTop:1},children:["📍 ",g.city]})]})]}),o.jsx("div",{style:{width:80,textAlign:"center",flexShrink:0},children:g.role&&g.role!=="player"?o.jsx(Pe,{role:g.role,size:"sm"}):o.jsx("span",{style:{fontSize:10,fontWeight:800,background:"rgba(22,101,52,0.08)",color:"#166534",padding:"2px 7px",borderRadius:4},children:"Player"})}),o.jsx("div",{style:{width:70,textAlign:"center",fontSize:13,fontWeight:800,color:"#0F172A",flexShrink:0},children:g.matchesPlayed}),o.jsxs("div",{style:{width:80,textAlign:"right",fontSize:14,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)",flexShrink:0},children:[g.points," ",o.jsx("span",{style:{fontSize:9.5,fontWeight:700,color:"#94A3B8"},children:"PTS"})]}),o.jsx("div",{style:{width:24,display:"flex",justifyContent:"flex-end",flexShrink:0},children:o.jsx($e,{size:15,color:"#CBD5E1"})})]},g.id)})]}):T?o.jsx(Z,{style:{padding:"32px 16px",textAlign:"center",borderRadius:14},children:o.jsxs("div",{style:{fontSize:13.5,color:"#64748B"},children:['No ranked players match "',q,'".']})}):null,M>=0&&o.jsxs("div",{style:{padding:"14px 18px",display:"flex",alignItems:"center",gap:14,background:"linear-gradient(135deg, rgba(22,101,52,0.08), rgba(22,101,52,0.02))",border:"1.5px solid rgba(22,101,52,0.3)",borderRadius:16,boxShadow:"0 4px 14px rgba(22,101,52,0.08)"},children:[o.jsx("div",{style:{width:42,height:42,borderRadius:"50%",background:"#166534",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,boxShadow:"0 2px 8px rgba(22,101,52,0.3)"},children:o.jsx(qe,{size:20,color:"#FFFFFF"})}),o.jsxs("div",{style:{flex:1,minWidth:0},children:[o.jsx("div",{style:{fontSize:12,color:"#166534",fontWeight:800,textTransform:"uppercase",letterSpacing:.5},children:"Your Season Ranking"}),o.jsxs("div",{style:{fontSize:17,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)",marginTop:2},children:["Rank #",M+1," ",o.jsxs("span",{style:{fontSize:12,fontWeight:600,color:"#64748B"},children:["of ",P.length," players"]})]})]}),o.jsxs("div",{style:{textAlign:"right",flexShrink:0},children:[o.jsxs("div",{style:{fontSize:20,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)"},children:[P[M].points," ",o.jsx("span",{style:{fontSize:11,fontWeight:700,color:"#94A3B8"},children:"PTS"})]}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:1},children:[P[M].matchesPlayed," matches played"]})]})]})]})),E&&o.jsx("div",{onClick:()=>N(null),style:{position:"fixed",inset:0,background:"rgba(15,23,42,0.5)",backdropFilter:"blur(4px)",zIndex:400,display:"flex",alignItems:"center",justifyContent:"center",padding:16},children:o.jsxs("div",{onClick:g=>g.stopPropagation(),style:{background:"#FFFFFF",borderRadius:20,maxWidth:440,width:"100%",padding:22,boxShadow:"0 24px 60px rgba(15,23,42,0.3)",maxHeight:"90vh",display:"flex",flexDirection:"column"},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:14},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12},children:[E.profile_image_url?o.jsx("img",{src:E.profile_image_url,alt:E.name,style:{width:50,height:50,borderRadius:"50%",objectFit:"cover",border:"2px solid #166534"}}):o.jsx(H,{name:E.name,id:E.id,sz:50}),o.jsxs("div",{children:[o.jsx("h3",{style:{margin:0,fontSize:16,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)"},children:E.name}),o.jsxs("div",{style:{fontSize:12,color:"#64748B",display:"flex",alignItems:"center",gap:6,marginTop:2},children:[o.jsx("span",{children:E.city||"Pune"}),o.jsx("span",{children:"·"}),o.jsx("span",{style:{fontWeight:700,color:"#166534"},children:E.role||"Player"})]})]})]}),o.jsx("button",{onClick:()=>N(null),style:{background:"none",border:"none",fontSize:22,cursor:"pointer",color:"#94A3B8",padding:0},children:"×"})]}),o.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:16,background:"#F8FAF8",padding:12,borderRadius:12,border:"1px solid #E2E8F0",textAlign:"center"},children:[o.jsxs("div",{children:[o.jsx("div",{style:{fontSize:10,color:"#94A3B8",fontWeight:700,textTransform:"uppercase"},children:"Rank"}),o.jsxs("div",{style:{fontSize:16,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)",marginTop:2},children:["#",P.findIndex(g=>g.id===E.id)+1]})]}),o.jsxs("div",{children:[o.jsx("div",{style:{fontSize:10,color:"#94A3B8",fontWeight:700,textTransform:"uppercase"},children:"Matches"}),o.jsx("div",{style:{fontSize:16,fontWeight:900,color:"#0F172A",fontFamily:"var(--font-head)",marginTop:2},children:E.matchesPlayed})]}),o.jsxs("div",{children:[o.jsx("div",{style:{fontSize:10,color:"#94A3B8",fontWeight:700,textTransform:"uppercase"},children:"Points"}),o.jsx("div",{style:{fontSize:16,fontWeight:900,color:"#166534",fontFamily:"var(--font-head)",marginTop:2},children:E.points})]})]}),o.jsxs("div",{style:{fontSize:12,fontWeight:800,color:"#0F172A",marginBottom:8,textTransform:"uppercase",letterSpacing:.3},children:["Verified Completed Matches (",((we=E.matches)==null?void 0:we.length)||0,")"]}),o.jsx("div",{style:{flex:1,overflowY:"auto",display:"grid",gap:8,paddingRight:2,maxHeight:240},children:(E.matches||[]).map((g,S)=>o.jsxs("div",{style:{padding:"9px 12px",background:"#F8FAF8",borderRadius:10,border:"1px solid #E2E8F0",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[o.jsxs("div",{style:{minWidth:0},children:[o.jsxs("div",{style:{fontSize:12.5,fontWeight:800,color:"#0F172A",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:[g.our_team||"Team"," vs ",g.team||"Opponent"]}),o.jsxs("div",{style:{fontSize:11,color:"#64748B",marginTop:1},children:["📅 ",g.date||"Completed"]})]}),o.jsx("span",{style:{fontSize:11,fontWeight:800,color:"#166534",background:"#DCFCE7",padding:"2px 7px",borderRadius:6,flexShrink:0},children:"+20 PTS"})]},S))}),o.jsx("button",{onClick:()=>N(null),style:{width:"100%",padding:"11px",borderRadius:10,background:"#166534",border:"none",color:"#FFFFFF",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"var(--font-head)",marginTop:16},children:"Close"})]})})]})}function Zr({player:e}){const[t,n]=F.useState(null),[a,r]=F.useState(!0),[s,l]=F.useState(!1),[d,c]=F.useState(!1);F.useEffect(()=>{We(e.id).then(n).catch(()=>{}).finally(()=>r(!1))},[e.id]);const u=async()=>{l(!0);try{const b=await Ne(e.id);n(b)}catch(b){alert(b.message)}l(!1)},p=async()=>{if(t!=null&&t.id){c(!0);try{await Me(t.id),n(null)}catch(b){alert(b.message)}c(!1)}};if(e.role==="pro"||a)return null;const f=t==null?void 0:t.status;return o.jsxs(Z,{style:{padding:"16px",marginTop:16},children:[o.jsxs("div",{style:{fontWeight:700,fontSize:14,color:"#0F172A",marginBottom:8,fontFamily:"var(--font-head)",display:"flex",alignItems:"center",gap:8},children:[o.jsx(Se,{size:17,color:"#166534"})," Schedule Your Own Matches"]}),o.jsx("div",{style:{fontSize:12,color:"#64748B",marginBottom:12,lineHeight:1.5},children:"Scheduling matches is a Pro feature. Request access below — once approved by your admin, you'll be able to schedule your own matches for 60 days."}),f==="pending"?o.jsxs(o.Fragment,{children:[o.jsx("div",{style:{padding:"10px 12px",background:"rgba(216,176,91,0.1)",borderRadius:10,color:"#B8860B",fontSize:12,fontWeight:700,textAlign:"center",marginBottom:10},children:"⏳ Your request is pending admin approval"}),o.jsx("button",{onClick:p,disabled:d,style:{width:"100%",padding:"9px",borderRadius:10,background:"transparent",border:"1.5px solid #E2E8F0",color:"#64748B",fontSize:12,cursor:"pointer",fontWeight:700,fontFamily:"var(--font-body)"},children:d?"Cancelling...":"Cancel Request"})]}):o.jsx("button",{onClick:u,disabled:s,style:{width:"100%",padding:"11px",borderRadius:10,background:"linear-gradient(135deg,#166534,#FFFFFF)",border:"none",color:"#0F172A",fontSize:13,cursor:"pointer",fontWeight:700,fontFamily:"var(--font-head)",display:"flex",alignItems:"center",justifyContent:"center",gap:8},children:s?"Sending...":f==="rejected"?"Request Again":o.jsxs(o.Fragment,{children:[o.jsx(Se,{size:15})," Request to Schedule Matches"]})})]})}const be="ss_session";function Ae(e,t=null){try{localStorage.setItem(be,JSON.stringify({role:e,player:t}))}catch{}}function sr(){try{return JSON.parse(localStorage.getItem(be)||"null")}catch{return null}}function rt(){try{localStorage.removeItem(be)}catch{}}class lr extends F.Component{constructor(t){super(t),this.state={hasError:!1,isChunkError:!1}}static getDerivedStateFromError(t){const n=((t==null?void 0:t.message)||(t==null?void 0:t.toString())||"").toLowerCase();return{hasError:!0,isChunkError:/dynamically imported|loading chunk|failed to fetch|chunkloaderror|import/i.test(n)}}componentDidCatch(t,n){console.error("SelectedSports App Error caught by boundary:",t,n);const a=((t==null?void 0:t.message)||(t==null?void 0:t.toString())||"").toLowerCase();if(/dynamically imported|loading chunk|failed to fetch|chunkloaderror|import/i.test(a)){const r=parseInt(sessionStorage.getItem("boundary_reload_ts")||"0",10);if(Date.now()-r>6e3){sessionStorage.setItem("boundary_reload_ts",String(Date.now()));const s=new URL(window.location.href);s.searchParams.set("_v",String(Date.now())),window.location.replace(s.toString())}}}render(){return this.state.hasError?this.state.isChunkError?o.jsxs("div",{style:{minHeight:"100vh",background:"#F8FAF8",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,textAlign:"center"},children:[o.jsx(Y,{}),o.jsx("p",{style:{marginTop:16,fontSize:13,color:"#64748B",fontWeight:600,fontFamily:"var(--font-head)"},children:"Updating application..."})]}):o.jsxs("div",{style:{minHeight:"100vh",background:"#F8FAF8",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,textAlign:"center",fontFamily:"var(--font-body)"},children:[o.jsx("div",{style:{width:64,height:64,borderRadius:"50%",background:"rgba(22,101,52,0.1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:32,marginBottom:16},children:"🏏"}),o.jsx("h2",{style:{fontSize:20,fontWeight:900,color:"#0F172A",margin:"0 0 8px",fontFamily:"var(--font-head)"},children:"Selected Sports"}),o.jsx("p",{style:{fontSize:13,color:"#64748B",maxWidth:360,margin:"0 0 20px",lineHeight:1.5},children:"Something unexpected happened. Tap below to reload."}),o.jsxs("div",{style:{display:"flex",gap:10,flexWrap:"wrap",justifyContent:"center"},children:[o.jsx("button",{onClick:()=>window.location.reload(),style:{padding:"12px 22px",borderRadius:12,background:"#166534",color:"#FFFFFF",border:"none",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"var(--font-head)"},children:"🔄 Reload App"}),o.jsx("button",{onClick:()=>{rt(),localStorage.clear(),window.location.href="/"},style:{padding:"12px 18px",borderRadius:12,background:"#FFFFFF",color:"#64748B",border:"1.5px solid #E2E8F0",fontSize:13,fontWeight:700,cursor:"pointer"},children:"Return to Home"})]})]}):this.props.children}}function L(e){return F.lazy(async()=>{try{return await e()}catch(t){console.warn("Chunk load failed, auto-reloading to fetch new version:",t);const n=parseInt(sessionStorage.getItem("chunk_reload_ts")||"0",10),a=Date.now();if(a-n>8e3){sessionStorage.setItem("chunk_reload_ts",String(a));const r=new URL(window.location.href);return r.searchParams.set("_v",String(a)),window.location.replace(r.toString()),new Promise(()=>{})}throw t}})}const cr=L(()=>D(()=>import("./LoginScreens-0sCkIzLT.js"),__vite__mapDeps([0,1,2,3])).then(e=>({default:e.UnifiedLoginScreen}))),dr=L(()=>D(()=>import("./LoginScreens-0sCkIzLT.js"),__vite__mapDeps([0,1,2,3])).then(e=>({default:e.RegisterScreen}))),ur=L(()=>D(()=>import("./LoginScreens-0sCkIzLT.js"),__vite__mapDeps([0,1,2,3])).then(e=>({default:e.RegistrationSubmittedScreen}))),pr=L(()=>D(()=>import("./AdminPortal-PndCwo4F.js").then(e=>e.A),__vite__mapDeps([4,1,5,6,2,7,3]))),fr=L(()=>D(()=>import("./PlayerPortal-Dwq3Y_IN.js"),__vite__mapDeps([7,1,2,3]))),mr=L(()=>D(()=>import("./ProPortal-Dx11WY89.js"),__vite__mapDeps([8,1,2,4,5,6,7,3]))),gr=L(()=>D(()=>import("./GroundOwnerPortal-Cmq39br-.js"),__vite__mapDeps([9,1,6,3]))),hr=L(()=>D(()=>import("./PublicInvitePage-B3Ao3I7V.js"),__vite__mapDeps([10,1,3]))),yr=L(()=>D(()=>import("./PublicAuctionView-CrH5BNgf.js"),__vite__mapDeps([11,1,3]))),br=L(()=>D(()=>import("./PublicAuctionRegister-DTYytXPo.js"),__vite__mapDeps([12,1,2,5,3]))),xr=L(()=>D(()=>import("./TeamOwnerView-CP05ktBs.js"),__vite__mapDeps([13,1,3])));function ie(){const t=new URLSearchParams(window.location.search).get("p");t&&window.history.replaceState(null,"",t)}function wr(){ie();const t=window.location.pathname.match(/\/join\/([a-zA-Z0-9\-]+)/);return t?t[1]:null}function _r(){ie();const e=window.location.pathname.match(/\/live-auction(?:\/([a-zA-Z0-9\-]+))?\/?$/);return e?e[1]||null:void 0}function Fr(){ie();const e=window.location.pathname.match(/\/auction-register(?:\/([a-zA-Z0-9\-]+))?\/?$/);return e?e[1]||null:void 0}function Sr(){ie();const e=window.location.pathname.match(/\/team-view\/([a-zA-Z0-9\-]+)\/([a-zA-Z0-9\-]+)\/?$/);return e?{auctionCode:e[1],teamId:e[2]}:null}function vr(){const[e,t]=F.useState("home"),[n,a]=F.useState(null),[r,s]=F.useState(!1),[l,d]=F.useState(!1),[c,u]=F.useState(!1),[p,f]=F.useState(!1),[b,y]=F.useState("player"),[m,h]=F.useState([]),[w,k]=F.useState(!1),[_,x]=F.useState(null),[v,z]=F.useState(null),[A,q]=F.useState(null),[C,E]=F.useState(null),N=async()=>{k(!0);try{h(await Ie())}catch{}k(!1)};F.useEffect(()=>{const P=Sr();if(P){E(P),t("teamView");return}const T=_r();if(T!==void 0){z(T),t("liveAuction");return}const W=Fr();if(W!==void 0){q(W),t("auctionRegister");return}const I=wr();if(I){x(I),t("publicInvite");return}const j=sr();(j==null?void 0:j.role)==="admin"||(j==null?void 0:j.role)==="founder"?(s(!0),a(j.player),t("portal")):(j==null?void 0:j.role)==="organizer"&&(j!=null&&j.player)?(s(!0),d(!0),a(j.player),t("portal")):(j==null?void 0:j.role)==="pro"&&(j!=null&&j.player)?(s(!1),u(!0),a(j.player),t("portal")):(j==null?void 0:j.role)==="ground_owner"&&(j!=null&&j.player)?(s(!1),f(!0),a(j.player),t("portal")):(j==null?void 0:j.role)==="player"&&(j!=null&&j.player)&&(s(!1),a(j.player),N().then(()=>t("portal")))},[]);const K=async P=>{const T=(P.phone||"").replace(/[^0-9]/g,"").slice(-10),W=Qa.replace(/[^0-9]/g,"").slice(-10);console.log("phone:",T,"adminPhone:",W);const I=T===W||P.role==="founder",j=!I&&P.role==="organizer",M=I||j,J=!M&&P.role==="pro";s(M),d(j),u(J),f(!1),a(P),M||await N(),Ae(I?"founder":j?"organizer":J?"pro":"player",P),t("portal")},se=P=>{f(!0),s(!1),d(!1),u(!1),a(P),Ae("ground_owner",P),t("portal")},B=()=>{rt(),a(null),s(!1),u(!1),d(!1),f(!1),h([]),t("home")};return o.jsx(lr,{children:o.jsxs(F.Suspense,{fallback:o.jsx("div",{style:{minHeight:"100vh",background:"#0F172A",display:"flex",alignItems:"center",justifyContent:"center"},children:o.jsx(Y,{})}),children:[e==="publicInvite"&&o.jsx(hr,{token:_}),e==="liveAuction"&&o.jsx(yr,{auctionCode:v}),e==="teamView"&&o.jsx(xr,{auctionCode:C==null?void 0:C.auctionCode,teamId:C==null?void 0:C.teamId}),e==="auctionRegister"&&o.jsx(br,{auctionCode:A}),e==="home"&&o.jsx(Za,{onLogin:P=>{y(P==="ground_owner"?"ground_owner":"player"),t("login")},onRegister:()=>t("register"),onGroundOwnerLogin:()=>{y("ground_owner"),t("login")}}),e==="register"&&o.jsx(dr,{onSuccess:()=>t("registered"),onBack:()=>t("home")}),e==="registered"&&o.jsx(ur,{onBack:()=>t("home")}),e==="login"&&o.jsx(cr,{initialMode:b,onAdminSuccess:K,onPlayerSuccess:K,onGroundOwnerSuccess:se,onBack:()=>t("home"),onRegister:()=>t("register")}),e==="portal"&&r&&o.jsx(pr,{player:n,onLogout:B,isFounder:!l}),e==="portal"&&!r&&p&&o.jsx(gr,{owner:n,onLogout:B}),e==="portal"&&!r&&!p&&c&&o.jsx(mr,{player:n,onLogout:B}),e==="portal"&&!r&&!p&&!c&&(w||!n?o.jsx("div",{style:{minHeight:"100vh",background:"#FBF3E7",display:"flex",alignItems:"center",justifyContent:"center"},children:o.jsx(Y,{})}):o.jsx(fr,{player:n,matches:m,onLogout:B}))]})})}"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(e=>{e.forEach(t=>t.unregister())}).catch(()=>{});"caches"in window&&caches.keys().then(e=>{e.forEach(t=>caches.delete(t))}).catch(()=>{});async function xe(){try{const e=await fetch("/version.json?_cb="+Date.now(),{cache:"no-store"});if(!e.ok)return;const t=await e.json();if(t!=null&&t.v&&t.v>1789199454719){console.warn("New build detected on server. Reloading to latest:",t.v,">",1789199454719);const n=new URL(window.location.href);n.searchParams.set("_v",String(t.v)),window.location.replace(n.toString())}}catch{}}xe();setInterval(xe,3e4);document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&xe()});window.addEventListener("vite:preloadError",e=>{e.preventDefault(),console.warn("Dynamic import preload error, fetching fresh bundle:",e);const t=parseInt(sessionStorage.getItem("vite_preload_ts")||"0",10);if(Date.now()-t>6e3){sessionStorage.setItem("vite_preload_ts",String(Date.now()));const n=new URL(window.location.href);n.searchParams.set("_v",String(Date.now())),window.location.replace(n.toString())}});window.addEventListener("unhandledrejection",e=>{var n;const t=((n=e.reason)==null?void 0:n.message)||String(e.reason||"");if(/dynamically imported|loading chunk|failed to fetch/i.test(t)){e.preventDefault();const a=parseInt(sessionStorage.getItem("unhandled_chunk_ts")||"0",10);if(Date.now()-a>6e3){sessionStorage.setItem("unhandled_chunk_ts",String(Date.now()));const r=new URL(window.location.href);r.searchParams.set("_v",String(Date.now())),window.location.replace(r.toString())}}});Ft.createRoot(document.getElementById("root")).render(o.jsx(St.StrictMode,{children:o.jsx(vr,{})}));export{Tr as $,Qa as A,Vr as B,Z as C,tr as D,Kt as E,Ar as F,Cr as G,Na as H,sa as I,qa as J,fa as K,Jr as L,nr as M,Sn as N,un as O,je as P,Wt as Q,Pe as R,Y as S,Yr as T,Ua as U,Va as V,Jt as W,Yt as X,Nr as Y,Wr as Z,D as _,Pr as a,Oa as a$,Dr as a0,Pa as a1,Ca as a2,Ba as a3,_a as a4,Ta as a5,he as a6,na as a7,Ea as a8,ma as a9,Te as aA,zn as aB,kn as aC,rn as aD,Rt as aE,ae as aF,Gt as aG,$t as aH,Je as aI,at as aJ,Or as aK,or as aL,Zn as aM,$r as aN,wa as aO,Tt as aP,Da as aQ,In as aR,ba as aS,xa as aT,zr as aU,qr as aV,tn as aW,ha as aX,Ma as aY,Xn as aZ,yn as a_,da as aa,Wa as ab,mn as ac,_n as ad,cn as ae,re as af,oe as ag,Ot as ah,Bn as ai,Oe as aj,Vt as ak,An as al,De as am,Ie as an,ka as ao,En as ap,qt as aq,qn as ar,pn as as,Ia as at,Dn as au,Fa as av,Aa as aw,Mn as ax,Cn as ay,Pn as az,Er as b,On as b0,ln as b1,nn as b2,ca as b3,tt as b4,Ya as b5,Ae as b6,rr as b7,Lr as b8,gn as b9,Ht as bA,Et as bB,zt as bC,$a as bD,Ct as bE,aa as ba,an as bb,Mr as bc,Ir as bd,ga as be,Ur as bf,Gr as bg,hn as bh,i as bi,za as bj,la as bk,Xt as bl,fn as bm,ya as bn,ja as bo,oa as bp,ea as bq,ta as br,pa as bs,Ha as bt,Mt as bu,Qt as bv,Zt as bw,Dt as bx,ra as by,Rn as bz,H as c,ir as d,Hr as e,Kr as f,ar as g,Zr as h,Ra as i,Fn as j,dn as k,Nt as l,fe as m,Qn as n,Ut as o,La as p,Ln as q,sn as r,Ka as s,Br as t,Rr as u,Ke as v,en as w,Tn as x,va as y,ua as z};

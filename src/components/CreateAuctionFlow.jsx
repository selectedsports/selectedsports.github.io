...
import { createAuction, fetchPlatformUpi, markAuctionPaidByOrganizer } from "../db.js"
...
export default function CreateAuctionFlow({ organizerId, isMobile, onClose, onCreated }) {
  ...
  const submitDetails = async () => {
    ...
    try {
      ...
      if (plan.price === 0) onCreated?.(auction)
      ...
      <div style={mBox} onClick={e => e.stopPropagation()}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:18 }}>
          <h3 style={{ margin:0, fontSize:17, fontWeight:800, color:"#0F172A", fontFamily:"var(--font-head)" }}>
            {step === "plan" ? "Choose a Plan" : step === "details" ? "Auction Details" : step === "payment" ? "Complete Payment" : "You're All Set!"}
          </h3>

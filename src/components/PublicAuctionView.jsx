  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflow: "hidden", position: "relative", height: "100%", display: "flex", alignItems: "center" }}>
        ...
        >
          ✨ Special thanks and support to <strong style={{ color: "#FFFFFF", fontWeight: 900 }}>Abdul Muizz</strong>, <strong style={{ color: "#FFFFFF", fontWeight: 900 }}>Farhan</strong>, <strong style={{ color: "#FFFFFF", fontWeight: 900 }}>Sahir</strong>, <strong style={{ color: "#FFFFFF", fontWeight: 900 }}>Nadeem</strong>, <strong style={{ color: "#FFFFFF", fontWeight: 900 }}>Aquib</strong>, and <strong style={{ color: "#FFFFFF", fontWeight: 900 }}>Arif</strong> for their tremendous support and contribution! ✨ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 🏏 Welcome to {tournamentName} — Official Live Player Auction &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 🌟 Special Thanks &amp; Support: <strong style={{ color: "#FFFFFF", fontWeight: 900 }}>Abdul Muizz · Farhan · Sahir · Nadeem · Aquib · Arif</strong> 🌟 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 🏆 Best of luck to all captains, franchise owners, and players! &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </marquee>
      </div>
    </div>
  )
